...
<?php if(isset($message)  and $_POST['doResendANumber']){?><div style="background:rgb(255, 90, 44); text-align:center; color:#FFF; padding:3px;"><?php echo $message;?></div><?php }?>

<?php if(isset($errormsgforgot)  and $_POST['doResendANumber']){?><div style="background:rgb(255, 90, 44); text-align:center; color:#FFF; padding:3px;"><?php echo $errormsgforgot;?></div><?php }?>
			...
			<div class="col-12 col-sm-7 col-sm-7 col-md-7 col-lg-7 mx-auto">
				<div class="forgot_wrapper">
					...
					<form action="" method="post" name="regForm" id="regForm" enctype="multipart/form-data">
						<div class="form-group"> 
						  	<input autocomplete="off" class="required form-control" name="name" type="text">
                     
						</div>
						 <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
					                            
                            <input name="doResendANumber" type="submit" class="btn btn-primary reset_pass_btn" value="Reset Password"/> 
						</div>	
					</form>
				</div>
			</div>												
