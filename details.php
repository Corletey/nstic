...
<body>
    <header class="header_inner contact_page">
        ...
        <?php
        $gr = $mysqli->real_escape_string($_GET['gr']);
        $sql_welcome_2 = "SELECT * FROM " . $prefix . "pages where id='$gr'";
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8 col-lg-8">
                        <div class="intro_text">
                            <h1><?php echo $rs_welcome_2['title']; ?></h1>
                            <div class="pages_links">
                                <a href="./" title=""><?php echo $lang_home; ?></a>
                                <a href="#" title="" class="active"><?php echo $rs_welcome_2['title']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-7 col-sm-7 col-md-7 col-lg-7 mx-auto">
                    <div class="forgot_wrapper">
                        ...
                        <h6><?php echo $rs_welcome_2['title']; ?></h6>
                        <?php if ($rs_welcome_2['details']) { ?><img src="./images/banner/<?php echo $rs_welcome_2['image_file']; ?>"> <?php } ?>
                        <p><a href="usermanual/GMS-UserGuideforApplicants.pdf" bis_skin_checked="1"> Click here to open the User Manual</a>.</p>
                        <p><?php echo $rs_welcome_2['details']; ?></p>
