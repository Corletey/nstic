...
if($_POST['doRegister'] and $_POST['fname'] and $_POST['username'] and $_POST['Institution'] and $_POST['phone'] and $_POST['email']){//$_POST['username']!=$_POST['pwd'] and  and $lowercase and $number =='Register'
...
//$mail->addBcc("uncstresearch@uncst.go.ug",'$lang_grants_management_system');
...
<p>
<a href='http://$hostmain$path/confirm.php?uncrd=$master2&code=$refNo'>$lang_ClicktoActivateAccount</a>
</p>


http://$hostmain$path/confirm.php?uncrd=$master2&code=$refNo</p>
...
// $mailgun->sendEmail($email, "$lang_grants_management_system - $lang_UserRegistration", $body);

// $mg = Mailgun::create('8be931be086b49d1c2e4e6eba89e8a37-4b98b89f-9f4f426d');

// $mg->messages()->send('mg.aau.org', [
//   'from'    => 'no_reply@mg.aau.org',
//   'to'      => $email,
//   'subject' => "$lang_grants_management_system - $lang_UserRegistration",
//   'html'    => $body
// ]);
$mail->MsgHTML($body);
...
<a href='http://$hostmain$path/mreset.php?subs=$refNo'>Click to Re-set Password</a><br><br>
Your username: $email<br><br>

http://$hostmain$path/mreset.php?subs=$refNo<br>
...
$usrm_username=$r['usrm_username'];
  // Match row found with more than 1 results  - the user is authenticated. 
    if ( $num <= 0 ) { 
	$errormsgforgot = '<p class="error2">$lang_expired_link <br><a href="http://$hostmain$path/forgot-password.php" class="text-center" style="color:#ffffff; text-decoration:underline; font-size:16px;">$lang_Clickheretoresetpasswordagain.</a></p>';
	$errormsg="true";
...
http://$hostmain$path/<br>
<a href='http://$hostmain$path/'>Click to Login</a>
<br><br>
...
$msg = "<p class='success'>$lang_CongratulationsPasswordReset<br><br><a href='http://$hostmain$path/' class='text-center' style='color:#000000; text-decoration:underline; font-size:16px;'>$lang_ClickheretoLogin</a></p>";	
$errormsg="false";
...
$sqlFGrpDisC=$mysqli->query($sqlGroupDIspC);//startDate>='$today' and 
                ...
                <!--    <div class="event_banner">
                    ...
                    <div class="event_info">
                        ...
                        <div class="events_time">
                            <span class="time"><i class="flaticon-clock-circular-outline"></i><?php echo $lang_Deadline;?>: </span>
                            <span><i class="fas fa-map-marker-alt"></i><?php echo $rGRSPC['EndDate'];?></span>
                        </div>
                         <p><?php echo $rGRSPC['details'];?> <?php if($rGRSPC['attachment']){?><a href="<?php echo $base_url;?>app/files/<?php echo $rGRSPC['attachment'];?>" title="" target="_blank"><?php echo $lang_ClicktoViewDetails;?></a><?php }?></p>
