...
<?php if(isset($errormessage) and $_POST['doRegister']){?><div style="background:rgb(255, 90, 44); text-align:center; color:#FFF; padding:3px;"><p class="error3" style="font-size:18px;"><?php echo $lang_username_withemail.' '.$email;?> <a href="#" class="nav-link join_now js-modal-show"><?php echo $lang_ClickheretoLogin;?></a></p></div><?php }?>
<?php if(isset($message)  and $_POST['doRegister']){?><div style="background:#92BF3E; text-align:center; color:#FFF; padding:3px;"><?php echo $lang_Dear. ' '.$fname.', '.$lang_accounthasbeensuccessfully;?></div><?php }?>
    ...
    <div class="story_about">
        <div class="container">            
            <div class="row">
                ...
                <div class="col-3" id="align"><b><?php echo $lang_Recent_Calls_Active;?></b><br><br>
                 <div class="btn"><?php TotalCalls();?></div>
                 </div>
                 
                 
                 <div class="col-3" id="align"><b><?php echo $lang_Number_Submissions_Received;?></b><br><br>
                       <div class="btn2"><?php NumberofSubmissionsReceived();?></div>
                       </div>
                       
                       <div class="col-3" id="align"><b><?php echo $lang_Grants_Awarded;?></b><br><br>
                       <div class="btn3"><?php GrantsAwarded();?></div>
                       </div>
                       
                       <div class="col-3" id="align"><b><?php echo $lang_Total_Users;?></b><br><br>
                       <div class="btn4"><?php TotalUsers();?></div>
                       </div>
