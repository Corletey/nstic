            ...
            <div class="row">        
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <h1><?php echo $lang_ConfirmAccount;?></h1>
                        <div class="pages_links">
                            <a href="./" title=""><?php echo $lang_home;?></a>
                            <a href="#" title="" class="active"><?php echo $lang_ConfirmAccount;?></a>
                        </div>
                    </div>
                </div>              
            </div>
		...
		<div class="row">
			<div class="col-12 col-sm-7 col-sm-7 col-md-7 col-lg-7 mx-auto">
				<div class="forgot_wrapper">
					<h6>Confirmation of your account</h6>	
				<?php
if(isset($_GET['uncrd']) && !empty($_GET['code']) && !empty($_GET['uncrd']) ) {
$user = $mysqli->real_escape_string($_GET['acia']);
$activ = $mysqli->real_escape_string($_GET['uncrd']);
//check if activ code and user is valid
$rs_check = "select * from ".$prefix."musers where usrm_no='$activ'";
$rMQuery=$mysqli->query($rs_check);
$num = $rMQuery->num_rows;
  // Match row found with more than 1 results  - the user is authenticated. 
  
    if (!$num) { 
	echo $msg = '<p class="error">ERROR: Sorry no such account exists on Grants Management System or activation code invalid or your account was already activated.<br><a href="/" class="text-center" style="color:#ffffff; text-decoration:underline; font-size:16px;">Back to Grants</a></p>';
...
$rs_activ = "update ".$prefix."musers set usrm_approved='1',usrm_no='' WHERE usrm_no='$activ'";
$mysqli->query($rs_activ);
echo $msg = '<p class="success">Congratulations!!!. Your account with the Grants Management System has been Activated, you can now login by clicking the link below.</p>';
echo '<h3><a href="#" class="nav-link join_now js-modal-show">Click here to Login</a></h3>';	 
