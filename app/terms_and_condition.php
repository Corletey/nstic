...
<div class="success"><?php echo $lang_accept_Terms;?>.</div>             
      <?php
	$conceptID=base64_decode($id);
	$owner_id=$_GET['owner_id'];
	
if($_POST['doAcceptTerms'] and $owner_id and $conceptID){
...
$sqlA2ProtocolaSS="update ".$prefix."submissions_concepts set TermsConditions='$TermsandConditions',signedagreement='$signedagreement2' where conceptID='$conceptID' and owner_id='$owner_id'";
...
$sql = "select * FROM ".$prefix."submissions_concepts where conceptID='$conceptID' order by conceptID desc limit 0,10";
...
<form action="" name="regForm" id="regForm" method="post" enctype="multipart/form-data" autocomplete="off">
                          ...
                          <h3 style="width:100%;"><?php echo $lang_Welcome_Terms;?>!</h3>

<?php echo $lang_dear;?> <?php echo $session_fullname;?>,<br><br>

<?php echo $lang_award_message1;?> <?php echo $rFLists2['BeginProject'];?>, the <?php echo $name_granting_council;?>	<?php echo $lang_award_message2;?>, <b><?php echo $rFLists2['projectTitle'];?></b><?php echo $lang_award_message3;?> <?php echo $rFLists2['BeginProject'];?> to <?php echo $rFLists2['EndProject'];?>.<br><br>

<?php echo $lang_AmountofGrantawarded;?>: <?php echo numberformat($rFLists2['AmountofGrantawarded']);?> <?php echo $rFLists2['currency'];?><br>
<?php echo $lang_DurationofGrant;?>: <?php echo $rFLists2['DurationofGrant'];?><br><br>

<?php echo $lang_please_download;?>.<br><br>
<a href="./files/<?php echo $rFLists2['award_agreement'];?>" target="_blank"><?php echo $lang_ClickdownloadGrantAgreement;?></a>
</div>
 ...
 <?php echo $lang_AcceptTermsandConditions;?> <input name="TermsandConditions" type="radio" value="Yes" required onChange="getAwardGrantedAccept(this.value)"> <?php echo $lang_Yes;?> <input name="TermsandConditions" type="radio" value="No" required onChange="getAwardGrantedAccept(this.value)"> <?php echo $lang_No;?>
