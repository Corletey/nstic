...
$sqlA2="update ".$prefix."pages_collaboration set `logo_img`='$newname',`logo_link`='$logo_link',`rank`='$rank' where id='$id'";
$mysqli->query($sqlA2);
}
if(!$_FILES["photo"]["name"]){
$sqlA2="update ".$prefix."pages_collaboration set `logo_link`='$logo_link',`rank`='$rank' where id='$id'";
$mysqli->query($sqlA2);
}
...
<form action="" method="post" name="regForm2" id="regForm2" autocomplete="off"  enctype="multipart/form-data">
 ...
 <?php 
$sql = "select *  FROM ".$prefix."pages_collaboration where id='$id' order by rank asc";//and conceptm_status='new' 
...
<div class="col-sm-7">
<textarea name="logo_link" cols="" rows="" class="form-control  required"><?php echo $rFLists2['logo_link'];?></textarea>
...
<div class="col-sm-7">
<?php if($rFLists2['logo_img']){?><img src="../images/logos/<?php echo $rFLists2['logo_img'];?>" /><?php }?>
