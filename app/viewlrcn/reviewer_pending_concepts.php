<?php
$sqlConceptLogs = "SELECT * FROM " . $prefix . "conceptsasslogs_new where conceptm_assignedto='$usrrsmyLoggedIdm' and logm_status='new' and categorym='concepts' order by assignm_date desc limit 0,20";
...
<div class="concepts-container">
  <div class="card">
    <div class="card-header">
      <h4 class="card-title">Pending Concepts for Review</h4>
    </div>
    <div class="card-body">
      <?php if (!$totalFL1) { ?>
          ...
          <table class="table table-hover table-striped">
            ...
            <tbody>
              ...
              while ($rFListsmain = $QueryConcept->fetch_array()) {
                ...
                $sqlFLists1Nd = "SELECT * FROM " . $prefix . "mscores_new where conceptm_id='$conceptm_id' and EvaluatedBy='$usrrsmyLoggedIdm' and categorym='concepts'";
              ...
              ?>
                <tr>
                  ...
                  <td data-label="<?php echo $lang_Action; ?>">
                    ...
                    <?php if (!$totalScores) { ?>
                      <a href="./main.php?option=reviewProjectInformation&id=<?php echo $rFLists2['conceptID']; ?>" class="btn btn-sm btn-primary"><?php echo $lang_ClicktoReview; ?></a>
                    <?php } ?>
                  </td>
                </tr>
              <?php } ?>
