...
<?php if($total_Information){?><button <?php if($rUConceptStages['ProjectInformation']==1){?>class="tablinks"<?php }?> Click="window.location.href='./main.php?option=newFirstInformation&id=<?php echo $id?>&categoryID=<?php echo $categoryID;?>&conceptID=<?php echo $conceptID;?>'"><?php echo $lang_new_ProjectInformation;?></button><?php }?>
...
$sqlA2="insert into ".$prefix."principal_investigators (`conceptm_id`,`owner_id`,`Surname`,`Othername`,`Gender`,`AgeRange`,`Contacts`,`Expertise`,`EducationalBackground`,`Qualifications`,`ResearchExperience`,`RoleofTeamMember`,`InstitutionofAffiliation`,`updatedon`,`is_sent`) 

values('$conceptm_id','$asrmApplctID','$Surname','$Othername','$Gender','$AgeRange','$Contacts','$Expertise','$EducationalBackground','$Qualifications','$ResearchExperience','$RoleofTeamMember','$InstitutionofAffiliation',now(),'0')";
$mysqli->query($sqlA2);
...
$sqlUsers4="SELECT * FROM ".$prefix."principal_investigators where `owner_id`='$asrmApplctID2' and piID='$PID' order by piID desc limit 0,10";
...
<?php
$QRp6="select * from ".$prefix."education_history where rstug_user_id='$asrmApplctID2' and is_sent='0' and piID='$PID'";
...
<a href="./main.php?option=newproposalResearchTeam&id=<?php echo $id?>&categoryID=<?php echo $categoryID;?>&conceptID=<?php echo $conceptID;?>" style="background-color:#06F; color:#fff;padding:5px;"><?php echo $lang_BacktoList;?> </a>
...
<div style="clear:both;"></div>
 <div class="row success">
    ...
    <input type="text" id="Contacts" name="Contacts" placeholder=".." class="required">
      </select>
    </div>
    
    <div class="rightm">
     <label for="lname"><?php echo $lang_Speciality;?> <span class="error">*</span></label>
      <input type="text" id="Expertise" name="Expertise" placeholder=".." class="required">
    </div>
