...
$mysqli->query($sqlAUpdate);*/
		...
		//////////////Update Now grantID
$sqlAUpdate="update ".$prefix."concept_dynamic_stages set `status`='new' where categorym='proposal' and `grantcallID`='$id'";
$mysqli->query($sqlAUpdate);
////Grants Table

$sqlAUpdate2="update ".$prefix."grantcall_categories set `status`='new' where categorym='proposal' and `grantID`='$id'";
...
echo "<meta http-equiv='REFRESH' content='0;url=$base_url/main.php?option=DynamicCallProposals&id=$id'>";
}
?>