                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Request for Revisons - Progress Report</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
Thank you for submitting <b>report</b> for project titled, '<b>$public_title</b>'.<br>
Your report NOT passed completeness check, you are advised to make the following revisions below;<br /><br />
<b>$rejectReasons</b><br><br>
