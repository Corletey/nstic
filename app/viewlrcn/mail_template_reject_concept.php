                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Administrative Review - $rstug_rsch_project_title</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
Thank you for responding to our call with a submission titled, '<b>$rstug_rsch_project_title</b>'.<br>

Your application has been found lacking the following: <br><br>

$rejectcomments<br><br>
We encourage you to respond to our subsquent calls for application<br>
