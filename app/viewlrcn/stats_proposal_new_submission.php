...
<?php if($status=='Pending Review'){
    $completedStatus="projectStatus='Pending Review'";
  
  ?>
 <h4 class="niceheaders"><?php echo $lang_PendingReview;?></h4>
 <?php }?>
 <?php if($status=='Pending Final Submission'){
   $completedStatus="projectStatus='Pending Final Submission'";
  ?>
 <h4 class="niceheaders"><?php echo $lang_PendingFinalSubmission;?></h4>
 <?php }?>
 <?php if($status=='Rejected'){
  $status2="Completeness Check-Rejected";
  $completedStatus="projectStatus='Completeness Check-Rejected'";
  
  ?>
 <h4 class="niceheaders"><?php echo $status2;?></h4>
 <?php }?>

<?php if($status=='Completeness Check-Approved'){
  $status2="Completeness Check-Approved";
  $completedStatus="(projectStatus='Completeness Check-Approved' || projectStatus='Completeness Check-Rejected')";
  ?>
 <h4 class="niceheaders"><?php echo $status2;?></h4>
 <?php }?>
 ...
 <?php if($status=='Scheduled for Review'){
  $status2="Scheduled for Review";
  $completedStatus="projectStatus='Scheduled for Review'";
  ?>
 <h4 class="niceheaders"><?php echo $lang_Rejected;?></h4>
 <?php }?>
  <?php if($status=='Reviewed'){
    $status2="Reviewed";
    $completedStatus="projectStatus='Reviewed'";
    ?>
 ...
 <?php if($status=='Approved'){
    ...
    $completedStatus="projectStatus='Reviewed'";
    ?>
 <h4 class="niceheaders">Approved</h4>
 <?php }?>
...
<?php
  ...
  $url='proposalNewSubmissions&id='.$id.'&status='.$status;
  $value='';
  ...
  */
  if($_POST['doSearch']){
  $query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_proposals where (finalSubmission='Made Final Submission' || finalSubmission='Pending Final Submission')  order by projectID desc");//and conceptm_status='new' 
  }
  
  if(!$_POST['doSearch']){
  $query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_proposals where $completedStatus order by projectID desc");//and conceptm_status='new' 
  }
  ...
  /* Get data. */
  if($_POST['doSearch']){
  $sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_proposals  where (finalSubmission='Made Final Submission' || finalSubmission='Pending Final Submission') order by projectID desc LIMIT $start, $limitm";//and conceptm_status='new' 
  }
  
  if(!$_POST['doSearch']){
 $sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_proposals  where $completedStatus order by  projectID desc LIMIT $start, $limitm";//and conceptm_status='new' 
  }
  ...
  */
  ...
  $rowsGrants=$RSGrants->fetch_array();
    ...
    <?php if($rFLists2['projectStatus']=='Approved' || $rFLists2['projectStatus']=='Completeness Check-Approved'){?><div class="btn-info-blue"><?php echo $lang_ApprovedforReview;?></div><?php }?>
  ...
  <?php if($rFLists2['projectStatus']=='Pending Review' and $rowsGrants['dynamic']=='Yes'){?><div  class='button3'><a href="./main.php?option=newreviewPrososal&id=<?php echo $rFLists2['projectID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ClicktoReviewProposal;?></a></div> <?php }?>
  ...
  <?php if($rFLists2['projectStatus']=='Approved' || $rFLists2['projectStatus']=='Completeness Check-Approved'){?><div  class='button3'><a href="./main.php?option=reviewPrososal&id=<?php echo $rFLists2['projectID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>" ><?php echo $lang_FowardforReview;?></a></div> <?php }?>
  
  <?php if(($rFLists2['projectStatus']=='Scheduled for Review' || $rFLists2['projectStatus']=='Reviewed')  and $rowsGrants['dynamic']=='No'){?><div  class='button3'><a href="./main.php?option=reviewPrososal&id=<?php echo $rFLists2['projectID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>" ><?php echo $lang_Reassign;?><?php echo $lang_ClicktoReviewProposal;?></a></div> <?php }?>
  
  <?php if(($rFLists2['projectStatus']=='Scheduled for Review' || $rFLists2['projectStatus']=='Reviewed')  and $rowsGrants['dynamic']=='Yes'){?><div  class='button3'><a href="./main.php?option=ReviewDynamicProposalAssign&id=<?php echo $rFLists2['projectID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>" ><?php echo $lang_Reassign;?></a></div> <?php }?>
  ...
  <?php if($rFLists2['projectStatus']=='Rejected' || $rFLists2['projectStatus']=='Completeness Check-Rejected' and ($session_usertype=='admin' || $session_usertype=='superadmin')){?>
<div class='btn-info-purple'>



<input id="go" type="button" value="Regrets" onclick="window.open('<?php echo $base_url;?>regrets.php?id=<?php echo $rFLists2['projectID'];?>&categorym=proposals&owner_id=<?php echo $owner_id;?>&grantID=<?php echo $rFLists2['grantcallID'];?>','popUpWindow','height=500, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="button2" ><br><br>

<input id="go" type="button" value="Comments" onclick="window.open('<?php echo $base_url;?>rejectcomments.php?id=<?php echo $rFLists2['projectID'];?>&categorym=proposals&owner_id=<?php echo $owner_id;?>&grantID=<?php echo $rFLists2['grantcallID'];?>','popUpWindow','height=500, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="button2" >

</div>
<?php }?>

<div  class='button3'><a href="./main.php?option=reviewPrososal&id=<?php echo $rFLists2['projectID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>" ><?php echo $lang_ClicktoViewDetails;?></a></div>
