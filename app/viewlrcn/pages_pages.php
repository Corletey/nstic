...
$sqlA2="insert into ".$prefix."pages (`section`,`title`,`details`,`image_file`,`rank`) values('$section','$title','$details','$newname','$rank')";
$mysqli->query($sqlA2);
}
if(!$_FILES["photo"]["name"]){
$sqlA2="insert into ".$prefix."pages (`section`,`title`,`details`,`image_file`,`rank`) values('$section','$title','$details','','$rank')";
$mysqli->query($sqlA2);
}

 $message="<span class=error2>$lang_details_saved.</span>"; 
}
if($category=="PagesDelete" and $id){
	
	$sqlA2="delete from ".$prefix."pages where id='$id'";
$mysqli->query($sqlA2);
...
<form action="" method="post" name="regForm2" id="regForm2" autocomplete="off"  enctype="multipart/form-data">
 ...
 <?php 
$sql = "select *  FROM ".$prefix."pages order by rank asc";//and conceptm_status='new' 
...
?>
                           ...
                           <a href="./main.php?option=UpdatePage&id=<?php echo $rFLists2['id'];?>"><?php echo $lang_ClicktoUpdateSubmission;?></a><br /><br />
                           <a href="./main.php?option=PagesDelete&id=<?php echo $rFLists2['id'];?>" onclick="return confirm('<?php echo $lang_AreyousureDelete;?>');" style="color:#F00;"><?php echo $lang_RemoveSubmission;?></a>
...
<option value="menu"><?php echo $lang_menu;?></option>
<option value="welcome"><?php echo $lang_Welcome;?></option>
<option value="tel_top"><?php echo $lang_TopTelephoneContacts;?></option>
<option value="bottom_contacts"><?php echo $lang_BottomTelephoneContacts;?></option>
<option value="email_top"><?php echo $lang_TopEmailContacts;?></option>
...
<div class="col-sm-7">
<textarea name="title" cols="" rows="" class="form-control  required"></textarea>
...
<div class="col-sm-7">
<textarea name="details" cols="" rows="" class="form-control  required"></textarea>
