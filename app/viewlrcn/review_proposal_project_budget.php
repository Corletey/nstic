...
$sqlASubmissionStages="update ".$prefix."review_proposals  set `Budget`='1' where `owner_id`='$owner_id' and status='new' and reviewer_id='$usrm_id'";
...
$sqlUsers2="SELECT * FROM ".$prefix."concept_budget where `owner_id`='$usrm_id' and `conceptID`='$conceptID' order by id desc limit 0,1";
...
<button <?php if($rProjectStages['PrincipalInvestigator']==1){?>class="tablinks"<?php }?>  onClick="window.location.href='./main.php?option=reviewProjectTeam&id=<?php echo $id;?>&grantID=<?php echo $grantID;?>'"><?php echo $lang_new_ProjectTeam;?>  </button>
  ...
  <button <?php if($rProjectStages['Background']==1){?>class="tablinks"<?php }?> onClick="window.location.href='./main.php?option=reviewproposalBackground&id=<?php echo $id;?>&grantID=<?php echo $grantID;?>'"><?php echo $lang_new_Background;?> </button>
    ...
    <button <?php if($rProjectStages['Budget']==1){?>class="tablinks"<?php }?> onclick="openCity(event, 'reviewproposalBudget')" id="defaultOpen"><?php echo $lang_new_Budget;?></button>
...
<div id="reviewproposalBudget" class="tabcontent">
...
<?php if($session_usertype=='superadmin' || $session_usertype=='admin'){include("proposal_assign_button_admin.php"); include("proposal_assign_button_admin2.php");}?>
 <?php if($session_usertype=='reviewer'){include("proposal_score_reviewer.php");}?> 
   ...
   <div class="success">
<p>Provide a detailed budget breakdown (in UGX) – (NB: Overhead costs should not exceed 5% of total budget)</p>
...
<table width="100%" border="1" align="left" cellpadding="0" cellspacing="0" class="tablem">
  ...
  <tr>
    ...
    <td width="203" valign="top">Personnel</td>
    <td width="328" valign="top"><?php echo $rUserInv2['Personnel'];?></td>
    <td width="209" valign="top" class="txtalign" align="center">8</td>
    <td width="275" valign="top"><?php echo $rUserInv2['PersonnelTotal'];?></td>
  </tr>
  <tr>
    <td width="30" valign="top">2. &nbsp;</td>
    <td width="203" valign="top">Research Costs</td>
    <td width="328" valign="top">
   
    <?php echo $rUserInv2['ResearchCosts'];?>
</td>
    <td width="209" valign="top" class="txtalign" align="center">60</td>
    <td width="275" valign="top"><?php echo $rUserInv2['ResearchCostsTotal'];?></td>
  </tr>
  <tr>
    <td width="30" valign="top">3. &nbsp;</td>
    <td width="203" valign="top">Equipment</td>
    <td width="328" valign="top">
   <?php echo $rUserInv2['Equipment'];?>
    
    </td>
    <td width="209" valign="top" class="txtalign" align="center">15</td>
    <td width="275" valign="top"><?php echo $rUserInv2['EquipmentTotal'];?></td>
  </tr>
<tr>
    <td width="30" valign="top">4. &nbsp;</td>
    <td width="203" valign="top">Travel and Subsistence</td>
    <td width="328" valign="top">
  <?php echo $rUserInv2['Travel'];?>
    </td>
    <td width="209" valign="top" class="txtalign" align="center">2</td>
    <td width="275" valign="top"><?php echo $rUserInv2['TravelTotal'];?></td>
  </tr>
  <tr>
    <td width="30" valign="top">5. &nbsp;</td>
    <td width="203" valign="top">Grant kick-off, mid-term and final workshops</td>
  ...
  <tr>
    ...
    <td width="203" valign="top">Knowledge Sharing and Research Uptake</td>
    <td width="328" valign="top">
<?php echo $rUserInv2['KnowledgeSharing'];?>
    
    </td>
    <td width="209" valign="top" class="txtalign" align="center">5</td>
    <td width="275" valign="top"><?php echo $rUserInv2['KnowledgeSharingTotal'];?></td>
  </tr>
  <tr>
    <td width="30" valign="top">7. &nbsp;</td>
    <td width="203" valign="top">Overhead costs</td>
    <td width="328" valign="top">
  ...
  <tr>
    ...
    <td width="203" valign="top">Other goods and services<br>
      Others (Specify)</td>
    <td width="328" valign="top">
<?php echo $rUserInv2['OtherGoods'];?>
  ...
  <tr>
    ...
    <td width="203" valign="top">Matching Support if any</td>
    <td width="328" valign="top">
<?php echo $rUserInv2['MatchingSupport'];?>
    
    </td>
    
    <td width="209" valign="top" class="txtalign" align="center">1</td>
    <td width="275" valign="top">    
  ...
  <tr>
    ...
    <td width="203" valign="top"><p align="center"><strong>TOTAL</strong></td>
    <td width="328" valign="top">&nbsp;</td>
    <td width="209" align="center" valign="top"><strong>100</strong></td>
    <td width="275" valign="top"><?php echo $rUserInv2['TotalSubmitted'];?></td>
  </tr>
</table>
