...
$sqlUsers4="SELECT * FROM ".$prefix."principal_investigators where `owner_id`='$asrmApplctID2' and grantcallID='$id' and piID='$piID' order by piID desc limit 0,10";
...
<?php
$QRp6="select * from ".$prefix."education_history where rstug_user_id='$asrmApplctID2' and grantcallID='$id' and piID='$piID'";
...
<table width="100%" border="0" id="customers">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded"><?php echo $lang_YearofEnrolment;?></th>
            <th scope="col" class="rounded"><?php echo $lang_YearofCompletio;?>  </th>
...
<?php
$QRp6="select * from ".$prefix."work_experience where rstug_user_id='$asrmApplctID2' and grantcallID='$id' and piID='$piID'";
$QRDp6=$mysqli->query($QRp6);
if($TotalsEduc=$QRDp6->num_rows){
?>
<div style="overflow-x:auto;">
<table width="100%" border="0" id="customers">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded"><?php echo $lang_YearofRecruitment;?></th>
            <th scope="col" class="rounded"><?php echo $lang_YearofDeparture;?> </th>
...
<a href="./main.php?option=newconceptPrincipalInvestigator&id=<?php echo $id;?>" style="background-color:#06F; color:#fff;padding:5px;"><?php echo $lang_BacktoList;?> </a>
