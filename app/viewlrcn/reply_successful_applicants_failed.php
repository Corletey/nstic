...
$mail->addBcc('mmawanda@i3c.co.ug','UNCST - $sitename');//
...
$queryC="update ".$prefix."concepts  set sentNotify='Failed',mailtext='$message' where conceptm_id='$conceptm_idmm'";
$mysqli->query($queryC);
////
$queryCss="update ".$prefix."musers  set sentNotify='Failed' where usrm_id='$piusrm_id'";
...
Reference is made to your application to the NSTIP Call for R&D Proposals for FY 2017/18  titled <b><?php echo $rsContribution['proposalmTittle'];?></b>.<br /><br />

<?php echo $name_granting_council;?> commends you for responding to the 2017/18 call for research proposals. Your concept proposal was evaluated by an independent technical evaluation committee and found to be plausible.<br /><br /> 

However, due to the stiff competition your research project was not selected by the technical evaluation committee for issuance of the NSTIP research grant.<br /><br /> 
