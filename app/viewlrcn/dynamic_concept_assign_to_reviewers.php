...
<?php 
if($_POST['doSubmit'] and $conceptID and $id){
...
$queryConceptLogs="select * from ".$prefix."conceptsasslogs_new where conceptm_id='$conceptm_id' and conceptm_assignedto='$cfnreviewer' and grantID='$id' order by assignm_id desc";
...
values('$conceptm_id','$cfnreviewer','$owner_id',now(),'new','concepts','$usrm_id','none','no',NULL,'dynamic','$id')";
$mysqli->query($queryLog2);	
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$mail->addBcc("$emailUsername",'$sitename');//
...
$message="A Concept, <b>$proposalTittle</b> has been assigned for review.";
...
<div class="tab">
  ...
  <button class="tablinks"  onclick="openCity(event, 'newReviewconceptAssign')" id="defaultOpen"><?php echo $lang_approve_rejectProcurement;?> </button>
  
  
</div>


<div id="newReviewconceptAssign" class="tabcontent">



  <h3><?php echo $lang_AssignConcept;?></h3><?php if($message){?><span style="color:#03F; font-size:18px;"><?php  echo $message;?></span> <?php }?>
...
$queryConceptLogs1="select * from ".$prefix."conceptsasslogs_new where conceptm_assignedto='$cfnreviewer' and conceptm_id='$conceptID' and grantID='$id'";
...
$rUserConceptLogs1['conceptm_assignedto'];
 ...
 <div class="row success">
    <input type="submit" name="doSubmit" value="<?php echo $lang_AssigntoReviewers;?>">
  </div>
