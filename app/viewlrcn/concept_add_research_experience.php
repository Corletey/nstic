...
?>
  <tr>
    ...
    <td><?php //echo $rUserInv2['EducationalBackground'];?>
      <a href="./main.php?option=conceptAddEducationBackground&id=<?php echo $rUserInv2['piID'];?>" style="background-color: #4CAF50; color:#fff;padding:5px;">Add/View Education Background</a><br /><br />
      <a href="./main.php?option=conceptAddResearchExperience&id=<?php echo $rUserInv2['piID'];?>" style="background-color: #4CAF50; color:#fff; padding:5px;">Add/View <?php echo $lang_ResearchExperience;?></a><br />
