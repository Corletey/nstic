...
?><div class="tab">
 ...
 <button <?php if($rUConceptStages['ProjectInformation']==1){?>class="tablinks"<?php }?> onClick="window.location.href='./main.php?option=SubmitConcept/<?php echo $id;?>/'"><?php echo $lang_new_ProjectInformation;?></button>
  ...
  <button <?php if($rUConceptStages['Budget']==1){?>class="tablinks"<?php }?>  onClick="window.location.href='./main.php?option=conceptBudget/<?php echo $id;?>/'"><?php echo $lang_new_Budget;?></button>
...
<div id="conceptProjectDetails" class="tabcontent">
 ...
 <label for="fname"><?php echo $lang_new_RequiredFieldsMarked;?> (<span class="error">*</span>)</label>
  ...
  <div class="row success">
    ...
    <div class="col-100">
    <label for="fname">Project primary beneficiaries (Max 50 words) (Numbers/Quantities, Gender, Locations etc.)</label>
...
<input name="ExpectedIntellectualProperty[]" type="checkbox" value="Industrial designs"  <?php if($chop1=='Industrial designs' || $chop2=='Industrial designs' || $chop3=='Industrial designs' || $chop4=='Industrial designs' || $chop5=='Industrial designs'){?>checked="checked"<?php }?>/> Industrial designs<br />

<input name="ExpectedIntellectualProperty[]" type="checkbox" value="Utility Models"  <?php if($chop1=='Utility Models' || $chop2=='Utility Models' || $chop3=='Utility Models' || $chop4=='Utility Models' || $chop5=='Utility Models'){?>checked="checked"<?php }?>/> Utility Models<br />

<input name="ExpectedIntellectualProperty[]" type="checkbox" value="Trade Marks"  <?php if($chop1=='Trade Marks' || $chop2=='Trade Marks' || $chop3=='Trade Marks' || $chop4=='Trade Marks' || $chop5=='Trade Marks'){?>checked="checked"<?php }?>/> Trade Marks<br />

<input name="ExpectedIntellectualProperty[]" type="checkbox" value="Trade Secrets" <?php if($chop1=='Trade Secrets' || $chop2=='Trade Secrets' || $chop3=='Trade Secrets' || $chop4=='Trade Secrets' || $chop5=='Trade Secrets'){?>checked="checked"<?php }?>/> Trade Secrets<br />

<input name="ExpectedIntellectualProperty[]" type="checkbox" value="Patent" <?php if($chop1=='Patent' || $chop2=='Patent' || $chop3=='Patent' || $chop4=='Patent' || $chop5=='Patent'){?>checked="checked"<?php }?>/> Patent
...
<table id="customers2" border="0">
        ...
        <tr>
            ...
            <td>  <select name="currencyPrimaryFunder" class="form-control required select"> 
   <option value="" selected="selected">Please Select</option>     
 <?php
$sqlUser = "SELECT * FROM ".$prefix."currency order by currency asc";
$queryUser = $mysqli->query($sqlUser);
...
<table id="customers2" border="0">
        ...
        <tr>
           ...
           <td>  <select name="currencySecondaryFunder" class="form-control select"> 
        <option value="" selected="selected">Please Select</option>      
 <?php
$sqlUser = "SELECT * FROM ".$prefix."currency order by currency asc";
$queryUser = $mysqli->query($sqlUser);
while($r = $queryUser->fetch_array()){?>
    <option value="<?php echo $r['currencyID'];?>" <?php if($r['currencyID']==$rUserInv2['currencySecondaryFunder']){?>selected="selected"<?php }?>>&nbsp;<?php echo $r['currency'];?></option>
    <?php }?>
       </select> 
           </td>
        </tr>
...
<label for="lname">b) Counterpart Funding by Host Institution</label>
 <div style="overflow-x:auto;">
...
<table id="customers2" border="0">
        ...
        <tr>
            ...
            <td>  <select name="currencyCounterpartFunding" class="form-control select"> 
            <option value="" selected="selected">Please Select</option>       
 <?php
$sqlUser = "SELECT * FROM ".$prefix."currency order by currency asc";
$queryUser = $mysqli->query($sqlUser);
while($r = $queryUser->fetch_array()){?>
    <option value="<?php echo $r['currencyID'];?>" <?php if($r['currencyID']==$rUserInv2['currencyCounterpartFunding']){?>selected="selected"<?php }?>>&nbsp;<?php echo $r['currency'];?></option>
    <?php }?>
       </select> 
           </td>
        </tr>
