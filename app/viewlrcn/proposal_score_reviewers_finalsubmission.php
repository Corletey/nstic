...
//////////////////////////////////////////////////////////////////////////////////////
$queryContribution2="select * from ".$prefix."submissions_proposals where projectID='$conceptm_id'";
...
//////////////////////////////////////////////////////////////////////////////
$sqlScoresMain = "SELECT * FROM ".$prefix."mscores_new where conceptm_id='$id' and EvaluatedBy='$conceptm_assignedto' and categorym='proposals'";
...
$categorym=$mysqli->real_escape_string($_POST['categorym']);
		...
		$sqlScores = "SELECT * FROM ".$prefix."mscores_new where conceptm_id='$conceptm_id' and EvaluatedBy='$conceptm_assignedto' and categorym='proposals'";
...
$queryScores2="update ".$prefix."submissions_proposals  set `projectStatus`='Reviewed',`conceptm_Reviewers`='$noReviewed' where `projectID`='$conceptm_id'";
$mysqli->query($queryScores2);
//}
if($conceptm_Times==0){
$queryScores2Times="update ".$prefix."submissions_proposals  set `conceptm_Times`='1' where `projectID`='$conceptm_id'";
$mysqli->query($queryScores2Times);
////My Scores
$sqlScoresCons = "update ".$prefix."mscores_new set `EvSame`='1' where conceptm_id='$conceptm_id' and EvaluatedBy='$conceptm_assignedto' and categorym='proposals'";
$mysqli->query($sqlScoresCons);
}
if($conceptm_Times>=1){
$queryScores2Timesw="update ".$prefix."submissions_proposals  set `conceptm_Times`='$conceptm_Times2' where `projectID`='$conceptm_id'";
$mysqli->query($queryScores2Timesw);
$sqlScoresConsd = "update ".$prefix."mscores_new set `EvSame`='2' where conceptm_id='$conceptm_id' and EvaluatedBy='$conceptm_assignedto' and categorym='proposals'";
$mysqli->query($sqlScoresConsd);
}
////////////////////update score logs///////////////////////////////////
$queryScores2d="update ".$prefix."conceptsasslogs_new  set `logm_status`='completed' where `conceptm_id`='$conceptm_id' and conceptm_assignedto='$conceptm_assignedto' and categorym='proposals'";
...
$mail->AddAddress("uncstuganda@gmail.com", "Grants Office"); //To Address -- CHANGE --
$mail->addBcc("$emailBcc",'UNCST - $sitename');//
$mail->AddReplyTo("uncstuganda@gmail.com", "$sitename Proposal Evaluated"); //Reply-To Address -- CHANGE --$usrm_email
