 ...
 <b>Progress/ Closure Reports</b></h4>
<?php

$page='main.php?';
$url='category=';
$value='AdmProgressReports&id='.$id;
...
<?php if($rFLists2['is_sent']==1){?><span  class="button3"><a href="./main.php?option=reviewProgressReport&id=<?php echo $rFLists2['progressID'];?>">Click to Review Report</a></span><?php }?>
                                                        </td>
