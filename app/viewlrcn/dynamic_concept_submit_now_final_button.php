...
$wmConfirm="select * from ".$prefix."dynamic_concept_stages where  owner_id='$usrm_id' and status='new' and grantID='$id'";
...
if($totalStagesConfirm<$totalStagesConfirm2 and $totalStagesConfirm and $totalStagesConfirm<=1){$stepsDone='20';}
if($totalStagesConfirm<$totalStagesConfirm2 and $totalStagesConfirm and $totalStagesConfirm>=2){$stepsDone='50';}
if($totalStagesConfirm<$totalStagesConfirm2 and $totalStagesConfirm and $totalStagesConfirm>=3){$stepsDone='75';}
...
if($totalStagesConfirm>=$totalStagesConfirm2){?><div class="btnm"><a href="./main.php?option=dynamicConceptSubmitNow&id=<?php echo $id;?>&categoryID=<?php echo $maincategoryID;?>" onclick="return confirm('Are you sure you want to submit your concept? click CANCEL to continue editing or OK to Submit Now.');"><?php echo $lang_submit_now;?></a></div>
<span style="color:#F00; font-weight:bold; font-size:16px;"><?php echo $lang_FinalCheckandSubmission;?><!-- <br />
To submit your concept note, please click submit now button. Only after having clicked on this button will your proposal be successfully submitted.--></span><?php }?>