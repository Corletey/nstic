                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        $lang_new_ProposalCalls - $rstug_rsch_project_title</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
$lang_dear $dbfirstname $dbsurname,<br><br>
Thank you for responding to our call with a submission titled, '<b>$rstug_rsch_project_title</b>'. Your application has been submitted on <b>$today</b>.<br /><br />
...
<b>Important: Please, do not reply to this mail.</b><br><br><br><br>
                                                </td>
                                            </tr>          
