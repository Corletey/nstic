                                        ...
                                        <tbody>
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                  ...
                                                  Acknowledgement of Grants Agreement</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<b>Re:</b> <b>Acknowledgement of Grants Agreement</b><br><br>
Dear $OwnerName2,<br><br>

We are pleased to inform you that on <b>$sesdatem</b>, the Grants Management Office Acknowledged receipt of the signed Grants Agreement for the proposal titled, <b>$public_title</b>.
<br><br>
Contact the grants office for further steps on the address below.<br><br>
Best Regards<br><br>

$fulladdress
http://localhost/scripts/grants/
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align='center' colspan='3' style='font-size:12px;line-height:1.5;padding-top:20px'>
                                                                    Copyright © $year Grants Management. <span>All rights reserved.</span>
                                                                </td>
                                                            </tr>
