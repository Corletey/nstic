<?php
$sqlQnsubmitted="SELECT * FROM ".$prefix."concept_dynamic_questions_all_a where categoryID='$categoryIDm' and catadmin_id='$sessionusrm_id' and grantID='$id' order by id desc";
...
<input name="categoryID" type="hidden" value="<?php echo $categoryIDm;?>" />
      ...
      <input type="text" id="MyTextBox" name="qn_title" placeholder="" class="required" value="<?php if($rowsSubmitted['qn_title']){echo $rowsSubmitted['qn_title'];}else{ echo "$lang_new_title";}?>" required>
    ...
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_title_number" class="requiredm" value="<?php if($rowsSubmitted['qn_title_number']){echo $rowsSubmitted['qn_title_number'];}else{echo "1";}?>" required>
   ...
   <tr>
    <td><input type="text" id="MyTextBox" name="qn_acronym" placeholder="" class="required" value="<?php if($rowsSubmitted['qn_acronym']){echo $rowsSubmitted['qn_acronym'];}else{ echo "$lang_new_titleacronmy";}?>" required>
  
</td>
    <td>

      <input type="text" id="MyTextBox" name="qn_acronym_number" class="requiredm" value="<?php if($rowsSubmitted['qn_acronym_number']){echo $rowsSubmitted['qn_acronym_number'];}else{echo "2";}?>" required>
 
</td>
    <td><input name="qn_acronym_status" type="radio" value="Disable" id="qn_acronym_status" class="required"  <?php if($rowsSubmitted['qn_acronym_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
  ...
  <tr>
    <td>
      <input type="text" id="MyTextBox" name="qn_relevantKeywords" placeholder="" class="required" value="<?php if($rowsSubmitted['qn_relevantKeywords']){echo $rowsSubmitted['qn_relevantKeywords'];}else{ echo "$lang_new_relevantKeywords";}?>" required>
   </td>
    <td>
      <input type="text" id="MyTextBox" name="qn_relevantKeywords_number" class="requiredm" value="<?php if($rowsSubmitted['qn_relevantKeywords_number']){echo $rowsSubmitted['qn_relevantKeywords_number'];}else{echo "3";}?>" required>
   </td>
    <td><input name="qn_relevantKeywords_status" type="radio" value="Disable" id="qn_relevantKeywords_status" class="required"  <?php if($rowsSubmitted['qn_relevantKeywords_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
...
<?php }?>
    ...
    <td>
      <input type="text" id="MyTextBox" name="qn_researchTypeID_number" class="requiredm" value="<?php if($rowsSubmitted['qn_researchTypeID_number']){echo $rowsSubmitted['qn_researchTypeID_number'];}else{echo "4";}?>" required>
   </td>
    <td><br />
   ...
   <tr>
    ...
    <td>
      <input type="text" id="MyTextBoxs" name="qn_HostInstitution_number" class="requiredm" value="<?php if($rowsSubmitted['qn_HostInstitution_number']){echo $rowsSubmitted['qn_HostInstitution_number'];}else{echo "5";}?>">
   </td>
    <td><input name="qn_HostInstitution_status" type="radio" value="Disable" id="qn_HostInstitution_status" class="required"  <?php if($rowsSubmitted['qn_HostInstitution_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
   ...
   <tr>
    <td><input type="text" id="qn_OrchidID" name="qn_OrchidID" placeholder="" class="required"  value="<?php if($rowsSubmitted['qn_OrchidID']){echo $rowsSubmitted['qn_OrchidID'];}else{ echo "$lang_new_ORCIDID";}?>" required>
   </td>
    <td>
      <input type="text" id="MyTextBoxs" name="qn_OrchidID_number" class="requiredm" value="<?php if($rowsSubmitted['qn_OrchidID_number']){echo $rowsSubmitted['qn_OrchidID_number'];}else{echo "6";}?>">
   </td>
...
<?php }?>
    ...
    <td>
      <input type="text" id="MyTextBox" name="qn_projectDurationID_number" class="requiredm" value="<?php if($rowsSubmitted['qn_projectDurationID_number']){echo $rowsSubmitted['qn_projectDurationID_number'];}else{echo "7";}?>" required>
   </td>
    <td><br /><input name="qn_projectDurationID_status" type="radio" value="Disable" id="qn_projectDurationID_status" class="required" <?php if($rowsSubmitted['qn_projectDurationID_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
