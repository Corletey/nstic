...
$sqlA2="insert into ".$prefix."principal_investigators (`conceptm_id`,`owner_id`,`Surname`,`Othername`,`Gender`,`AgeRange`,`Contacts`,`<?php echo $lang_Expertise;?>`,`EducationalBackground`,`Qualifications`,`ResearchExperience`,`RoleofTeamMember`,`InstitutionofAffiliation`,`updatedon`,`is_sent`) 

values('$conceptm_id','$asrmApplctID','$Surname','$Othername','$Gender','$AgeRange','$Contacts','$$lang_Expertise','$EducationalBackground','$Qualifications','$ResearchExperience','$RoleofTeamMember','$InstitutionofAffiliation',now(),'0')";
$mysqli->query($sqlA2);
...
$sqlUsers4="SELECT * FROM ".$prefix."principal_investigators where `owner_id`='$asrmApplctID2' and `is_sent`='0' and piID='$id' order by piID desc limit 0,10";
...
<table width="100%" border="0" id="customers">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Year of Enrolment</th>
            <th scope="col" class="rounded">Year  of Completion  </th>
...
while($QR_Totalp6=$QRDp6->fetch_array())
{
	...
	?>
    	<tr>
        	...
        	<td><?php echo $QR_Totalp6['completionyear'];?></td>
...
<?php
$QRp6="select * from ".$prefix."work_experience where rstug_user_id='$asrmApplctID2' and is_sent='0' and piID='$id'";
$QRDp6=$mysqli->query($QRp6);
if($TotalsEduc=$QRDp6->num_rows){
?>
<div style="overflow-x:auto;">
<table width="100%" border="0" id="customers">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Year of Recruitment</th>
            <th scope="col" class="rounded">Year of Departure </th>
...
<a href="./main.php?option=conceptPrincipalInvestigator" style="background-color:#06F; color:#fff;padding:5px;">Back to Project Teams </a>
