...
<form action="./main.php?option=freview&id=<?php echo $id;?>" method="post" name="regForm" id="regForm"  enctype="multipart/form-data">
...
<div class="box box-danger">
           ...
           <?php if($rsContribution['cpt_othersector']){?>Other Sector: <?php echo $rsContribution['cpt_othersector'];?><br /><?php }?>
                                    ...
                                    <div class="alert alert-success alert-dismissable">
                                        <i class="fa fa-check"></i>
                                      <a href="<?php echo 'files/'.$rsContribution['proposalm_upload'];?>" target="_blank" style="font-size:20px;">Download File</a>
                                    </div>
...
<div id="statediv"></div>
<?php /*?> <?php if(!$rsContribution['proposalm_uploadReup']){?>  <input name="status" type="radio" value="Approve for Review" class="required"  onChange="getState(this.value)"/> <span style="color:#06F; font-weight:bold;"><?php echo $lang_ApprovedforReview;?></span><br />
    <input name="status" type="radio" value="Reject Submission" class="required"  onChange="getState(this.value)"/> <span style="color:#F00; font-weight:bold;">&nbsp;Reject Submission</span><br /><br />

<div id="statediv"></div><?php }?><?php */?>
    
<input name="doSubmit" type="submit" class="btn btn-info btn-flat" value="Submit"/> &nbsp;
