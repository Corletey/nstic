...
if($id){
$sqlA2="update ".$prefix."grantcalls set  `summary`='$summary',`details`='$details',`startDate`='$startDate',`EndDate`='$EndDate' where `grantID`='$id'";
$mysqli->query($sqlA2);
echo '<meta http-equiv="Refresh" content="2; url='.$base_url.'main.php?option=CallConcepts" />';
}
...
<?php if($message){?><div style="color:#F00; font-size:18px;"><?php echo $message;?></div><?php }?>
 ...
 <label for="fname"><?php echo $lang_new_RequiredFieldsMarked;?> (<span class="error">*</span>)</label>
  ...
  <?php if($rUserInv2['category']=='grants'){?>
...
<option value="<?php echo $rUserInv24['grantID'];?>" <?php if($rUserInv2['conceptID']==$rUserInv24['grantID']){?>selected="selected"<?php }?>><?php echo $rUserInv24['title'];?></option>
<?php }?>
