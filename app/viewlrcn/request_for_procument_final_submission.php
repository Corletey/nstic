...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'requestFunds')" id="defaultOpen">Request for Procument</button>
...
<div id="requestFunds" class="tabcontents">
  <span onclick="this.parentElement.style.display='none'" class="topright">&times</span>
  

    
  <h3>Request for Procument </h3>

 <?php
$sessionusrm_id=$_SESSION['usrm_id'];
$grantID=$mysqli->real_escape_string($_GET['grantID']);
if($category=='RequestforProcFinal' and $id and $sessionusrm_id and $grantID){
...
$mail->addCc("$emailBcc",'Request for Procurement');
...
$sqlA2="update ".$prefix."request_for_procument set  `actionStatus`='Submitted',`is_sent`='1' where owner_id='$sessionusrm_id' and `projectID`='$id' and grantID='$grantID'";
$mysqli->query($sqlA2);
