...
if($category=='RequestforFundsFinalConcept' and $id and $sessionusrm_id and $grantID){
...
echo $sqlUsers="SELECT * FROM ".$prefix."request_for_funds_main where `conceptID`='$id' and owner_id='$sessionusrm_id'  and grantID='$grantID' order by id desc limit 0,1";
...
$sqlA2="update ".$prefix."request_for_funds set  `actionStatus`='Submitted',`is_sent`='1' where owner_id='$sessionusrm_id' and `conceptID`='$id' and grantID='$grantID'";
$mysqli->query($sqlA2);

$sqlA22="update ".$prefix."request_for_funds_main set  `actionOnRequest`='Submitted',`is_sent`='1' where owner_id='$sessionusrm_id' and `conceptID`='$id' and grantID='$grantID'";
$mysqli->query($sqlA22);

echo '<img src="img/loading_wait.gif">';
echo '<div class="spacer"></div>';
echo "<meta http-equiv='REFRESH' content='0;url=$base_url/main.php?option=dashboard&id=$id'>";
