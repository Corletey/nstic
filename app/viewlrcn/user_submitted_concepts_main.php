...
if($status=="Pending Final Submission"){
$sql = "select * FROM ".$prefix."submissions_concepts where owner_id='$usrm_id' and (projectStatus='Pending Final Submission' || projectStatus='Completeness Check-Resubmission') order by conceptID desc limit 0,50";
}
 
if($status!="Pending Final Submission"){
$sql = "select * FROM ".$prefix."submissions_concepts where owner_id='$usrm_id' and projectStatus='$status' order by conceptID desc limit 0,50";
}
 ...
 <div class="table-responsive">
                                                ...
                                                <table class="table table-mailbox" width="100%">
                                                    <tr class="unread" style="font-size:16px;">
                                                        ...
                                                        <th width="120" class="time"><strong><?php echo $lang_Date;?></strong></th>
...
if($rFListsScores['Total']){$TotalScore=($rFListsScores['Total']/$TotalReviewers);}///$rFListsScores['TotalReviewers']
							  ...
							  ?>
                                                   <tr class="unread" style="font-size:13px;">
                                                        ...
                                                        <td width="120" class="time"><p style="font-size:16px;"><?php echo $rFLists2['updated'];?></p></td>
...
<?php 
if($rFLists2['projectStatus']=='Pending Review' || $rFLists2['projectStatus']='Completeness Check-Resubmission' and $rFLists2['dynamic']=='No'){?><div class='button4'><a href="./main.php?option=UpdateMySubmitConcept&id=<?php echo $rFLists2['conceptID'];?>"><?php echo $lang_ClicktoUpdateSubmission;?></a></div>
<?php }?>

<?php 
//and $rFListsScoresCalls['EndDate']>=$today  
if(($rFLists2['projectStatus']=='Pending Review' || $rFLists2['projectStatus']=='Completeness Check-Resubmission' || $rFLists2['projectStatus']=='Completeness Check-Rejected') and $rFLists2['dynamic']=='Yes'){?><div class='button4'><a href="./main.php?option=newConceptMySubmission&id=<?php echo $rFLists2['grantcallID'];?>&conceptID=<?php echo $rFLists2['conceptID'];?>"><?php echo $lang_ClicktoUpdateSubmission;?></a></div>
<?php }?>
...
<?php if($rFLists2['projectStatus']=='Reviewed' and $rFLists2['invited_for_proposal']=='notinvited'){ echo "<span class='button1'>$lang_ConceptHasbeenReviewed</span>";}?>
  ...
  <input id="go" type="button" value="Rejected" onclick="window.open('comments.php?id=<?php echo $rFLists2['conceptID'];?>','popUpWindow','height=700, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="btn-info-red" >
...
<div class='button3'> <a href="./main.php?option=reviewProjectInformation&id=<?php echo $rFLists2['conceptID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div><?php }?>
                                                  ...
                                                  <tr class="unread" style="font-size:16px;">
                                                        ...
                                                        <td class="small-col" colspan="4"><strong><?php echo $lang_no_results_displayed;?></strong></td>
