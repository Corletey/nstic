 <h4 class="success">
 <span  class="button2" style="float:right;"><a href="./main.php?option=submitProgressReport&id=<?php echo $rFLists2['grantID'];?>"> <?php echo $lang_SubmitProgressReports;?></a></span>
...
<?php if($rFLists2['reportStatus']=='Pending'){?><div  class='button3'><?php echo $lang_Pending;?></div><?php }?>
<?php if($rFLists2['reportStatus']=='Submitted'){?><div  class='button2'><?php echo $lang_Submitted;?></div> <?php }?>
<?php if($rFLists2['reportStatus']=='Approved'){?><div  class='button2'><?php echo $lang_Approved;?></div> <?php }?>
<?php if($rFLists2['reportStatus']=='Rejected'){?><div  class='button2'><?php echo $lang_RequestforRevisions;?></div> <?php }?>
...
<?php if($rFLists2['reportStatus']=='Pending' || $rFLists2['reportStatus']=='Submitted' || $rFLists2['reportStatus']=='Rejected'){?><span  class="button3"><a href="./main.php?option=UpdateProgressReport&id=<?php echo $rFLists2['progressID'];?>"><?php echo $lang_UpdateReport;?></a></span><?php }?>
                                                        </td>
