...
if($_POST['doSaveData']=='Save' and $_POST['Surname'] and $_POST['asrmApplctID']){
	...
	$sqlUsers="SELECT * FROM ".$prefix."principal_investigators where `owner_id`='$asrmApplctID' and `Surname`='$Surname' and `conceptm_id`='$conceptm_id' order by piID desc limit 0,1";
...
$sqlA2="insert into ".$prefix."principal_investigators (`conceptm_id`,`owner_id`,`Surname`,`Othername`,`Gender`,`AgeRange`,`<?php echo $lang_Contacts;?>`,`<?php echo $lang_Expertise;?>`,`EducationalBackground`,`Qualifications`,`ResearchExperience`,`ResearchExperienceDetails`,`RoleofTeamMember`,`InstitutionofAffiliation`,`updatedon`,`is_sent`) 

values('$conceptm_id','$asrmApplctID','$Surname','$Othername','$Gender','$AgeRange','$Contacts','$Expertise','$EducationalBackground','$Qualifications','$ResearchExperience','$ResearchExperienceDetails','$RoleofTeamMember','$InstitutionofAffiliation',now(),'0')";
$mysqli->query($sqlA2);
...
$Insert_QR2="insert into ".$prefix."work_experience (`rstug_user_id`,`conceptID`,`Institution`,`PositionHeld`,`YearofRecruitment`,`YearofDeparture`,`dateAdded`,`is_sent`,`piID`) values ('$asrmApplctID','$conceptm_id','$Institution','$PositionHeld','$YearofRecruitment','$YearofDeparture',now(),'0','$conceptm_id')";
$mysqli->query($Insert_QR2);
...
$sqlProjectID2="SELECT * FROM ".$prefix."submissions_proposals where `owner_id`='$usrm_id' and `is_sent`='0' order by projectID desc limit 0,1";
...
$sqlASubmissionStages="update ".$prefix."project_stages  set `ResearchTeam`='1',`PrincipalInvestigatorEducation`='1',`PrincipalInvestigatorResearch`='1' where `owner_id`='$usrm_id' and `projectID`='$projectID2' and status='new'";
$mysqli->query($sqlASubmissionStages);


$sqlUsers4="SELECT * FROM ".$prefix."principal_investigators where `owner_id`='$asrmApplctID2' and `conceptm_id`='$conceptIDm' order by piID desc limit 0,10";
...
?>
  <tr>
   ...
   <a href="./main.php?option=proposalAddEducationBackground&id=<?php echo $rUserInv2['piID'];?>" style="background-color: #4CAF50; color:#fff;padding:5px;">View Details </a>
...
<div style="clear:both;"></div>
 <div class="row success">
    ...
    <input type="text" id="<?php echo $lang_Contacts;?>" name="<?php echo $lang_Contacts;?>" placeholder=".." class="requireds" required>
      </select>
    </div>
