...
if ($_POST['doAddSiteConfiguration']) {
  ...
  if ($_FILES["photo"]["name"]) {
    $sqlA2 = "insert into " . $prefix . "slider (`txt_1`,`txt_2`,`txt_3`,`image`,`rank`) values('$txt_1','$title','$txt_3','$newname','$rank')";
    $mysqli->query($sqlA2);
  }
  if (!$_FILES["photo"]["name"]) {
    $sqlA2 = "insert into " . $prefix . "slider (`txt_1`,`txt_2`,`txt_3`,`image`,`rank`) values('$txt_1','$txt_2','$txt_3','','$rank')";
    $mysqli->query($sqlA2);
  }
...
<h4 class="niceheaders"><?php echo $lang_Slider; ?> </h4>
<hr />
...
<form action="" method="post" name="regForm2" id="regForm2" autocomplete="off" enctype="multipart/form-data">
  ...
  <?php
  $sql = "select *  FROM " . $prefix . "slider order by rank asc"; //and conceptm_status='new' 
    ...
    <div class="modal-body" style="height:300px; overflow:scroll;">
      ...
      <form action="" method="post" name="regForm" id="regForm" enctype="multipart/form-data">
        ...
        <div class="form-group row success" style="padding-top:10px;">
          ...
          <div class="col-sm-7">
            <textarea name="txt_1" cols="" rows="" class="form-control  required"></textarea>
        ...
        <div class="form-group row success" style="padding-top:10px;">
          ...
          <div class="col-sm-7">
            <textarea name="txt_2" cols="" rows="" class="form-control  required"></textarea>
