...
$sqlA1="update ".$prefix."musers set `usrm_approved`='1' where usrm_id='$id'";
$mysqli->query($sqlA1);

$usrm_username=$sqUser['usrm_username'];
$email=$sqUser['usrm_email'];
$fname=$sqUser['usrm_fname'].' '.$sqUser['usrm_sname'];
$activ_code = rand(1000,9999);

require("viewlrcn/class.phpmailer.php");
require("viewlrcn/class.smtp.php"); echo "Passed";
	////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$mail->AddReplyTo($email, $fname); //To Address -- CHANGE --
...
$mail->addBcc("mwesigwa.collins@gmail.com",'Grants Management');
...
Please be reminded that the deadline for submission is <b>11th June 2023</b>. Please visit the grants web page https://grants.slrencommunity.edu.sl and login with your credentials below:<br>
Username:<b>$usrm_username</b><br>
Password:<b>Grants@$activ_code</b><br><br>
For any technical challenges with the system, please send a WhatsApp to <b>076685170</b>.<br><br>

Best Regards<br>
Grants Management Team @NSTIC
</p>
...
if(!$mail->Send()){
 ...
 <h4 class="niceheaders">Applicants</h4>
...
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."musers where usrm_usrtype='user' order by usrm_fname asc");
}
if($searchResearchers){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."musers where usrm_usrtype='user' and (usrm_fname like '%$searchResearchers' OR usrm_email like '%$searchResearchers%') order by usrm_fname asc");
}
...
/* Get data. */
if(!$searchResearchers){
$sql = "select *,DATE_FORMAT(`usrm_updated`,'%W, %D %M %Y') AS cfn_regdatem from ".$prefix."musers where usrm_usrtype='user' order by usrm_fname asc LIMIT $start, $limitm";
}
if($searchResearchers){
$sql = "select *,DATE_FORMAT(`usrm_updated`,'%W, %D %M %Y') AS cfn_regdatem from ".$prefix."musers where usrm_usrtype='user' and (usrm_fname like '%$searchResearchers' OR usrm_email like '%$searchResearchers%') order by usrm_fname asc LIMIT $start, $limitm";
}
	...
	?>
                   <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $sq['usrm_email'];?><br />
                                                <a href="./main.php?option=Users&id=<?php echo $sq['usrm_id'];?>&action=resend">Re-send Logins</a>
...
<span style="color:#09F; font-weight:bold; font-size:13px;"><?php if($sq['usrm_usrtype']=='user'){echo "Applicant";}?></span>
                                                ...
                                                <td align="right">
<a href="./main.php?option=DisableUsers&id=<?php echo $sq['usrm_id'];?>"  style="background-color:#F00; color:#fff;padding:5px;" onclick="return confirm('Are you sure you want to Disable this account?');">Disable Account</a>
