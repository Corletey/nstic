...
$page='main.php?';
$url='category=';
$value='AllNewDynamicProposals&id='.$id;
...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."dynamic_proposal_titles where finalSubmission='Made Final Submission' and grantID='$id' order by dproposalID desc");//and proposalm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`dateUpdated`,'%d/%m/%Y') AS dateUpdatedm FROM ".$prefix."dynamic_proposal_titles  where finalSubmission='Made Final Submission' and grantID='$id' order by dproposalID desc LIMIT $start, $limitm";//and proposalm_status='new' 
}
...
<div class="clear"></div>
                                                    ...
                                                    <tr class="unread">
                                                      ...
                                                      <th width="161" class="subject"><strong><?php echo $lang_Submittedby;?></strong></th>
                                                        ...
                                                        <th width="165" class="time">Reviewer</th>
...
$dproposalID=$rFLists2['dproposalID'];
...
$sqlwwScores = "select *,count(EvaluatedBy) AS TotalReviewers,sum(EvTotalScore) AS Total FROM ".$prefix."mscores_new where usrm_id='$owner_id' and conceptm_id='$dproposalID'  and categorym='concepts' group by conceptm_id order by scoredmID desc limit 0,10";
...
$color="#C0E4C2";
  ...
  <input id="go" type="button" value="Rejected" onclick="window.open('comments.php?id=<?php echo $rFLists2['dproposalID'];?>','popUpWindow','height=700, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="btn-info-red" >
  ...
  <?php if($rFLists2['projectStatus']=='Scheduled for Review'){?><div class="btn-info-blue"><?php echo $lang_Scheduled_for_Review;?></div><?php }?>
                                                 ...
                                                 <?php
$queryCategoryReview="select * from ".$prefix."mscores_new where conceptm_id='$dproposalID' and usrm_id='$owner_id'  and categorym='concepts'";
...
<div class='button2'><a href="./main.php?option=reviewDynamicProposalinformation&id=<?php echo $rFLists2['grantID'];?>&categoryID=<?php echo $rFLists2['categoryID'];?>&ownerm_id=<?php echo $rFLists2['owner_id'];?>&dproposalID=<?php echo $rFLists2['dproposalID'];?>">Click to Review</a></div> <?php }?>

<?php if($rFLists2['projectStatus']=='Reviewed'){?>
<div class='button3'><a href="./main.php?option=reviewDynamicProposalinformation&id=<?php echo $rFLists2['grantID'];?>&categoryID=<?php echo $rFLists2['categoryID'];?>&ownerm_id=<?php echo $rFLists2['owner_id'];?>&dproposalID=<?php echo $rFLists2['dproposalID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div> <?php }?>

<?php if($rFLists2['projectStatus']=='Approved'){?>
<div class='button3'><a href="./main.php?option=reviewDynamicProposalinformation&id=<?php echo $rFLists2['grantID'];?>&categoryID=<?php echo $rFLists2['categoryID'];?>&ownerm_id=<?php echo $rFLists2['owner_id'];?>&dproposalID=<?php echo $rFLists2['dproposalID'];?>"><?php echo $lang_FowardforReview;?></a></div> <?php }?><br />

<?php if($rFLists2['projectStatus']=='Scheduled for Review'){?>
<div class='button2'><a href="./main.php?option=reviewDynamicProposalinformation&id=<?php echo $rFLists2['grantID'];?>&categoryID=<?php echo $rFLists2['categoryID'];?>&ownerm_id=<?php echo $rFLists2['owner_id'];?>&dproposalID=<?php echo $rFLists2['dproposalID'];?>&dproposalID=<?php echo $rFLists2['dproposalID'];?>">Re-assign Proposal </a></div> <?php }?><br />



<?php if($rFLists2['invited_for_proposal']!='invited' and $rFLists2['projectStatus']=='Reviewed'){?>

<div class="button2"><a href="main.php?option=InviteForFullProposal&id=<?php echo $id;?>&concepid=<?php echo $rFLists2['dproposalID'];?>" onclick="return confirm('Are you sure you want to Invite to Submit full Proposal? Click OK to confirm or CANCEL.');"><?php echo $lang_InvitetoSubmitfullProposal;?></a></div>
<?php }?>
