...
if($_POST['doSaveData'] and $sessionusrm_id and $id){
...
$PersonnelDescription=$mysqli->real_escape_string($_POST['PersonnelDescription']);
	$ResearchCostsDescription=$mysqli->real_escape_string($_POST['ResearchCostsDescription']);
	$EquipmentDescription=$mysqli->real_escape_string($_POST['EquipmentDescription']);
	$TravelDescription=$mysqli->real_escape_string($_POST['TravelDescription']);
	$kickoffDescription=$mysqli->real_escape_string($_POST['kickoffDescription']);
	$KnowledgeSharingDescription=$mysqli->real_escape_string($_POST['KnowledgeSharingDescription']);
	$OverheadCostsDescription=$mysqli->real_escape_string($_POST['OverheadCostsDescription']);
  	$OtherGoodsDescription=$mysqli->real_escape_string($_POST['OtherGoodsDescription']);
  	$MatchingSupportDescription=$mysqli->real_escape_string($_POST['MatchingSupportDescription']);
	...
	$sqlUsersrr="SELECT * FROM ".$prefix."submissions_proposals where `owner_id`='$sessionusrm_id' and `projectStatus`='Pending Final Submission' and `is_sent`='0' order by projectID desc limit 0,1";
		$QueryUsersrr = $mysqli->query($sqlUsersrr);
		$rUserInvrr=$QueryUsersrr->fetch_array();
	  $conceptm_id=$rUserInvrr['projectID'];
	
	$sqlUsers="SELECT * FROM ".$prefix."concept_budget where `owner_id`='$sessionusrm_id' and grantcallID='$id'  order by id desc limit 0,1";
		$QueryUsers = $mysqli->query($sqlUsers);
		$totalUsers = $QueryUsers->num_rows;
		$rUserInv=$QueryUsers->fetch_array();
///Check total submitted budget
/*if($Personnel and $ResearchCosts and $Equipment and $kickoff and $Travel and $KnowledgeSharing){
$totalsubmittedbyUser=($Personnel+$ResearchCosts+$Equipment+$kickoff+$Travel+$KnowledgeSharing);	
}
*/
$totalsubmittedbyUser=($TotalSubmitted);	
	$asrmApplctID2=$mysqli->real_escape_string($sessionusrm_id);
	
if($totalUsers and $_POST['asrmApplctID']){

$sqlA2="update ".$prefix."concept_budget set  `Personnel`='$Personnel',`PersonnelTotal`='$PersonnelTotal',`ResearchCosts`='$ResearchCosts',`ResearchCostsTotal`='$ResearchCostsTotal',`Equipment`='$Equipment',`EquipmentTotal`='$EquipmentTotal',`kickoff`='$kickoff',`kickoffTotal`='$kickoffTotal',`KnowledgeSharing`='$KnowledgeSharing',`KnowledgeSharingTotal`='$KnowledgeSharingTotal',`OverheadCosts`='$OverheadCosts',`OverheadCostsTotal`='$OverheadCostsTotal',`OtherGoods`='$OtherGoods',`OtherGoodsTotal`='$OtherGoodsTotal',`MatchingSupport`='$MatchingSupport',`TotalBudget`='$TotalBudget', `PersonnelDescription`='$PersonnelDescription',`ResearchCostsDescription`='$ResearchCostsDescription',`EquipmentDescription`='$EquipmentDescription',`TravelDescription`='$TravelDescription',`kickoffDescription`='$kickoffDescription',`KnowledgeSharingDescription`='$KnowledgeSharingDescription',`OverheadCostsDescription`='$OverheadCostsDescription',`OtherGoodsDescription`='$OtherGoodsDescription',`MatchingSupportDescription`='$MatchingSupportDescription',`TotalSubmitted`='$TotalSubmitted' where owner_id='$sessionusrm_id' and grantcallID='$id'";// and is_sent='1'
$mysqli->query($sqlA2);

echo '<img src="img/loading_wait.gif">';
echo '<div class="spacer"></div>';

echo '<meta http-equiv="REFRESH" content="0;url='.$base_url.'main.php?option=newproposalResults&id='.$id.'&categoryID='.$categoryID.'&conceptID='.$conceptID.'">';
}
if(!$totalUsers and $sessionusrm_id){
$sqlmain="insert into ".$prefix."concept_budget (`Personnel`,`PersonnelTotal`,`ResearchCosts`,`ResearchCostsTotal`,`Equipment`,`EquipmentTotal`,`kickoff`,`kickoffTotal`,`Travel`,`TravelTotal`,`KnowledgeSharing`,`KnowledgeSharingTotal`,`OverheadCosts`,`OverheadCostsTotal`,`OtherGoods`,`OtherGoodsTotal`,`MatchingSupport`,`MatchingSupportTotal`,`TotalBudget`,`TotalSubmitted`,`owner_id`,`projectCategory`,`PersonnelDescription`,`ResearchCostsDescription`,`EquipmentDescription`,`TravelDescription`,`kickoffDescription`,`KnowledgeSharingDescription`,`OverheadCostsDescription`,`OtherGoodsDescription`,`MatchingSupportDescription`,`is_sent`,`conceptID`,`grantcallID`) 

values('$Personnel','$PersonnelTotal','$ResearchCosts','$ResearchCostsTotal','$Equipment','$EquipmentTotal','$kickoff','$kickoffTotal','$Travel','$TravelTotal','$KnowledgeSharing','$KnowledgeSharingTotal','$OverheadCosts','$OverheadCostsTotal','$OtherGoods','$OtherGoodsTotal','$MatchingSupport','$MatchingSupportTotal','$TotalBudget','$TotalSubmitted','$sessionusrm_id','Proposal','$PersonnelDescription','$ResearchCostsDescription','$EquipmentDescription','$TravelDescription','$kickoffDescription','$KnowledgeSharingDescription','$OverheadCostsDescription','$OtherGoodsDescription','$MatchingSupportDescription','0','$conceptm_id','$id')";
$mysqli->query($sqlmain);
...
$r= $cmdwb->fetch_array();
if($totalStages){
$sqlASubmissionStages="update ".$prefix."project_stages  set `Budget`='1' where `owner_id`='$sessionusrm_id' and grantID='$id'";
...
$sqlUsers2="SELECT * FROM ".$prefix."concept_budget where `owner_id`='$sessionusrm_id' and grantcallID='$id' order by id desc limit 0,1";
$QueryUsers2 = $mysqli->query($sqlUsers2);//and conceptID='$conceptID' 
...
$sqlUsers="SELECT * FROM ".$prefix."submissions_proposals where `owner_id`='$sessionusrm_id' and `grantcallID`='$id' order by projectID desc limit 0,1";
		$QueryUsers = $mysqli->query($sqlUsers);
		$totalUsers = $QueryUsers->num_rows;
		$rUserInv=$QueryUsers->fetch_array();
		$TotalBudget=$rUserInv['Totalfunding'];
?>
<?php
...
<?php if($total_Budget){?><button <?php if($rUConceptStages['Budget']==1){?>class="tablinks"<?php }?> onclick="openCity(event, 'newproposalBudget')" id="defaultOpen"><?php echo $lang_new_Budget;?></button><?php }?>
...
<div id="newproposalBudget" class="tabcontent">
...
<div class="success">
<?php
$sqlDynamic="SELECT * FROM ".$prefix."concept_dynamic_questions_all_e where categorym='proposal' and grantID='$id' order by id asc";
...
<textarea id="PersonnelDescription" name="PersonnelDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['PersonnelDescription'];?><?php echo $rowsSubmitted_c['PersonnelDescription'];?></textarea>
</td>
...
function fnc(value, min, max) 
{
    ...
    <input type="text" id="Personnel" name="Personnel" placeholder="" class="requiredm number" value="<?php if($rUserInv2['Personnel']){echo $rUserInv2['Personnel'];}else{ echo $_POST['Personnel'];}?>" min="1" max="<?php echo $mmPersonnelTotal;?>" onkeyup="imposeMinMax(this)">
  ...
  <td width="241" valign="top">
  <textarea id="ResearchCostsDescription" name="ResearchCostsDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['ResearchCostsDescription'];?><?php echo $rowsSubmitted_c['ResearchCostsDescription'];?></textarea>
</td>
    <td width="561" valign="top">
...
<?php if($highlightfield=='true'){$mm='border:solid 2px #F30;';}?>
 ...
 <td width="241" valign="top">
  <textarea id="EquipmentDescription" name="EquipmentDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['EquipmentDescription'];?><?php echo $rowsSubmitted_c['EquipmentDescription'];?></textarea>
</td>
    <td width="561" valign="top">
       <script type="text/javascript">
...
<td width="241" valign="top">
  <textarea id="TravelDescription" name="TravelDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['TravelDescription'];?><?php echo $rowsSubmitted_c['TravelDescription'];?></textarea></td>
    <td width="561" valign="top">
...
function fnc4(value, min, max) 
{
 ...
 <td width="241" valign="top">
  <textarea id="kickoffDescription" name="kickoffDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['kickoffDescription'];?><?php echo $rowsSubmitted_c['kickoffDescription'];?></textarea></td>
    <td width="561" valign="top">
...
function fnc5(value, min, max) 
{
  ...
  <tr>
    ...
    <td width="241" valign="top">
  <textarea id="KnowledgeSharingDescription" name="KnowledgeSharingDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['KnowledgeSharingDescription'];?><?php echo $rowsSubmitted_c['KnowledgeSharingDescription'];?></textarea></td>
</div>
</div></td>
    <td width="561" valign="top">


    <input type="text" id="KnowledgeSharing" name="KnowledgeSharing" placeholder="May include both costs for scientific publications    (e.g. open Access publication) and other dissemination materials (e.g.    reports, leaflets, websites etc.), workshops and training of stakeholder    engagement, capacity building and communication targeting end user and public." class="requiredm number"  value="<?php if($rUserInv2['KnowledgeSharing']){echo $rUserInv2['KnowledgeSharing'];}else{ echo $_POST['KnowledgeSharing'];}?>">
    
    </td>
    <td width="86" valign="top" class="txtalign" align="center"><?php echo $rowsDynamic['qn_KnowledgeSharing_Ceiling'];?></td>
    <td width="144" valign="top"><input type="text" id="KnowledgeSharingTotal" name="KnowledgeSharingTotal" placeholder=".." class="requiredm number" value="<?php echo ($mmKnowledgeSharing);?>" required></td>
  </tr>
  <?php }?>
...
<td width="241" valign="top">
  <textarea id="OverheadCostsDescription" name="OverheadCostsDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['OverheadCostsDescription'];?><?php echo $rowsSubmitted_c['OverheadCostsDescription'];?></textarea></td>
    <td width="561" valign="top">
...
function fnc7(value, min, max) 
{
 ...
 <td width="241" valign="top">
  <textarea id="OtherGoodsDescription" name="OtherGoodsDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['OtherGoodsDescription'];?><?php echo $rowsSubmitted_c['OtherGoodsDescription'];?></textarea></td>
    <td width="561" valign="top">
...
<td width="241" valign="top">
  <textarea id="MatchingSupportDescription" name="MatchingSupportDescription" placeholder="Give a break down of the Costs" style="height:100px" class="requiredm" required><?php echo $rUserInv2['MatchingSupportDescription'];?><?php echo $rowsSubmitted_c['MatchingSupportDescription'];?></textarea></td>
    <td width="561" valign="top">
