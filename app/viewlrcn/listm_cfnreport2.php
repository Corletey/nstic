 ...
 <h4 class="niceheaders">Search Reports</h4><hr />
...
$sqlConcepts3="SELECT * FROM ".$prefix."submissions_proposals where researchTypeID='$rstug_categoryID' order by projectID desc";
$queryConcepts3=$mysqli->query($sqlConcepts3);
$TotalC_submitted3 = $queryConcepts3->num_rows;
	
	$ho=$cc++;
?>
<div class="col-mm10 halfgraph3"><?php echo $ho;?>. <?php echo $rGRSPCv['rstug_categoryName'];?> <strong><a href="./main.php?option=Reports&id=<?php echo $rGRSPCv['rstug_categoryID'];?>">[<?php echo ($TotalC_submitted3);?>]</a></strong></div>
...
*/
if($id){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_concepts where finalSubmission='Made Final Submission' and researchTypeID='$id' order by conceptID desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($id){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts  where finalSubmission='Made Final Submission' and researchTypeID='$id' order by conceptID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}

if(!$id){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts  where finalSubmission='Made Final Submission' order by conceptID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
...
$rFListsOnwner2=$R_DMain2->fetch_array(); 	
															  ...
															  ?>
                                                    <tr>
                                                      <td class="small-col"><?php echo $rFLists2['project_title'];?><br />
