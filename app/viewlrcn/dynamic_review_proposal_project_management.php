...
$sqlASubmissionStages="update ".$prefix."review_proposals  set `ProjectManagement`='1' where `owner_id`='$owner_id' and status='new' and reviewer_id='$usrm_id' and projectID='$id' and grantID='$grantID'";
...
<?php if($total_Results){?><button <?php if($rProjectStages['ProjectResults']==1){?>class="tablinks"<?php }?> onClick="window.location.href='./main.php?option=newreviewproposalResults&id=<?php echo $id;?>&grantID=<?php echo $grantID;?>'"><?php echo $lang_new_ProjectResults;?></button><?php }?>
  ...
  <?php if($total_Management){?><button <?php if($rProjectStages['ProjectManagement']==1){?>class="tablinks"<?php }?> onclick="openCity(event, 'newreviewproposalManagement')" id="defaultOpen"><?php echo $lang_new_ProjectManagement;?></button><?php }?>
...
<div id="newreviewproposalManagement" class="tabcontent">
...
<br /><a href="./files/<?php echo $rUserInv2['overallCoordination'];?>" target="_blank"><strong><?php echo $lang_new_Attachments;?></strong></a><?php }?>
    </div>
  </div><?php }?>
...
<br /><a href="./files/<?php echo $rUserInv2['GantChart'];?>" target="_blank"><strong><?php echo $lang_ClicktoViewDetails;?></strong></a><?php }?>
