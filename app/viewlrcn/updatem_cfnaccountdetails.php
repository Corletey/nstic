...
$sqlA1="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_password`='$md5pass',`usrm_phone`='$phone',`usrm_profilepic`='$newname',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob',`usrm_usrtype`='$usrm_usrtype' where usrm_id='$id'";
$mysqli->query($sqlA1);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}

if($_FILES["profilepic"]["name"] and !$_POST['pwd']){
$sqlA2="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_phone`='$phone',`usrm_profilepic`='$newname',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob',`usrm_usrtype`='$usrm_usrtype' where usrm_id='$id'";
$mysqli->query($sqlA2);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
...
if(!$_FILES["profilepic"]["name"] and $_POST['pwd']){
$sqlA3="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_password`='$md5pass',`usrm_phone`='$phone',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob',`usrm_usrtype`='$usrm_usrtype' where usrm_id='$id'";
$mysqli->query($sqlA3);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
...
if(!$_FILES["profilepic"]["name"] and !$_POST['pwd']){
$sqlA4="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_phone`='$phone',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob',`usrm_usrtype`='$usrm_usrtype' where usrm_id='$id'";
$mysqli->query($sqlA4);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
