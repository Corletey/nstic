...
if($category=='InviteForFullProposal' and $id){
...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_concepts where grantcallID='$id' order by conceptID desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts where grantcallID='$id'  order by conceptID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
...
///Invite for full proposal
$sqlProps="SELECT * FROM ".$prefix."grantcalls where grantID='$grantcallID' and proposal_submitted='Yes'  and  requirefullproposal='Yes' order by grantID asc";
$QueryProps = $mysqli->query($sqlProps);
$rowsProps=$QueryProps->fetch_array();
$TotalProposalCalls=$QueryProps->num_rows;

//End Review
$sqlProps2="SELECT * FROM ".$prefix."grantcalls where grantID='$grantcallID' order by grantID asc";
$QueryProps2 = $mysqli->query($sqlProps2);
$rowsProps2=$QueryProps2->fetch_array();
...
if($dynamic=='No'){
$sqlwwScores = "select EvaluatedBy,usrm_id,conceptm_id,sum(EvTotalScore) AS Total FROM ".$prefix."mscores_dynamic where usrm_id='$owner_id' and conceptm_id='$conceptID'  and categorym='concepts' group by EvaluatedBy order by EvaluatedBy desc";
$resultwwScores = $mysqli->query($sqlwwScores);
$rFListsScores=$resultwwScores->fetch_array();

$sqlwwScores2 = "select DISTINCT(EvaluatedBy) AS TotalReviewers FROM ".$prefix."mscores_dynamic where usrm_id='$owner_id' and conceptm_id='$conceptID'  and categorym='concepts' group by EvaluatedBy order by EvaluatedBy desc";
...
<?php if($rFLists2['projectStatus']=='Pending Final Submission'){?><div class="btn-info-black"><?php echo $lang_PendingFinalSubmission;?></div><?php }?>
  ...
  <?php if($rFLists2['projectStatus']=='Completeness Check-Resubmission'){?><div class="btn-info-red"><?php echo $lang_CompletenessCheckResubmission;?></div><?php }?>
  
  </td>
                                                      <td class="time"><strong style="font-size:16px; font-weight:bold; color:#F00;"><?php echo ($TotalScore);?></strong><br />
...
<?php
if($dynamic=='No'){
$queryCategoryReview="select EvaluatedBy,conceptm_id,usrm_id from ".$prefix."mscores_new where conceptm_id='$conceptID' and usrm_id='$owner_id'  and categorym='concepts' group by EvaluatedBy order by EvaluatedBy";
...
<input id="go" type="button" value="<?php echo $rFListsReviewer['usrm_sname'];?> <?php echo $rFListsReviewer['usrm_fname'];?>, View <?php echo $lang_Score;?>" onclick="window.open('adminscoresheet.php?id=<?php echo $EvaluatedBy;?>&ds=<?php echo $rFListsScores3['scoredmID'];?>','popUpWindow','height=700, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="btn-info-blue" ><br /><?php }?>                                                
...
if($dynamic=='Yes'){
$queryCategoryReview="select EvaluatedBy,conceptm_id,usrm_id from ".$prefix."mscores_dynamic where conceptm_id='$conceptID' and usrm_id='$owner_id'  and categorym='concepts' group by EvaluatedBy order by EvaluatedBy";
$R_CategoryReview=$mysqli->query($queryCategoryReview);	
while($rCReview=$R_CategoryReview->fetch_array()){
	 $EvaluatedBy=$rCReview['EvaluatedBy']; 
...
$rFListsReviewer=$R_DReviewer->fetch_array();
	...
	?>
    <?php if($TotalScore and $rFListsReviewer['usrm_sname']){?>
<input id="go" type="button" value="<?php echo $rFListsReviewer['usrm_sname'];?> <?php echo $rFListsReviewer['usrm_fname'];?>, View <?php echo $lang_Score;?>" onclick="window.open('scoresheetdynamic.php?id=<?php echo $EvaluatedBy;?>&ds=<?php echo $rFListsScores3['scoredmID'];?>&grantID=<?php echo $rFLists2['grantcallID'];?>&dconceptID=<?php echo $conceptID;?>','popUpWindow','height=700, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="btn-info-blue" ><br /><?php }?>                                                
...
<?php if($rFLists2['projectStatus']=='Pending Review' and $rFLists2['dynamic']=='No'){?>
<div class='button2'><a href="./main.php?option=reviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div> <?php }?>

<?php if($rFLists2['projectStatus']=='Pending Review' and $rFLists2['dynamic']=='Yes'){?>
<div class='button2'><a href="./main.php?option=newreviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div> <?php }?>
...
<?php if($rFLists2['projectStatus']=='Reviewed' and $rFLists2['dynamic']=='No'){?>
<div class='button3'><a href="./main.php?option=reviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div> <?php }?>
<?php if($rFLists2['projectStatus']=='Reviewed' and $rFLists2['dynamic']=='Yes'){?>
<div class='button3'><a href="./main.php?option=newreviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ClicktoViewDetails;?></a></div> <?php }?>



<?php if($rFLists2['projectStatus']=='Completeness Check-Approved' and $rFLists2['dynamic']=='No' and $session_usertype=='admin'){?>
<div class='button3'><a href="./main.php?option=reviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_FowardforReview;?></a></div> <?php }?><br />

<?php if($rFLists2['projectStatus']=='Completeness Check-Approved' and $rFLists2['dynamic']=='Yes' and $session_usertype=='admin'){?>
<div class='button3'><a href="./main.php?option=newreviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_FowardforReview;?></a></div> <?php }?><br />


<?php if($rFLists2['projectStatus']=='Scheduled for Review' and $rFLists2['dynamic']=='No' and $session_usertype=='admin'){?>
<div class='button2'><a href="./main.php?option=reviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ReassignConcept;?> </a></div> <?php }?><br />

<?php if($rFLists2['projectStatus']=='Scheduled for Review' and $rFLists2['dynamic']=='Yes' and $session_usertype=='admin'){?>
<div class='button2'><a href="./main.php?option=newreviewProjectInformation&conceptID=<?php echo $rFLists2['conceptID'];?>&id=<?php echo $rFLists2['grantcallID'];?>"><?php echo $lang_ReassignConcept;?> </a></div> <?php }?><br />

<?php if($rFLists2['invited_for_proposal']!='invited' and $rFLists2['projectStatus']=='Reviewed' and $session_usertype=='admin'){?>

<?php
//Below check whether Full Proposal has been added before you invite PIs to submit

if($TotalProposalCalls){
?>
...
<?php }
}//end $TotalProposalCalls
if(!$TotalProposalCalls and $rFLists24['requirefullproposal']=='Yes'){
?>
<div class="error"><a href="<?php echo $base_url;?>main.php?option=DynamicCallProposals"><?php echo $lang_customizeCallforProposals;?></a></div>
<?php }
if(!$TotalProposalCalls and $TotalReviewers>=1 and $rowsProps2['end_review']=='Yes'  and $rFLists2['awarded']=='No' || $rFLists2['awarded']==''){
?>
<input id="go" type="button" value="<?php echo $lang_ClicktoAwardGrant;?>" onclick="window.open('<?php echo $base_ur;?>awardgrantconcept.php?id=<?php echo $rFLists2['conceptID'];?>&categorym=concepts&owner_id=<?php echo $owner_id;;?>','popUpWindow','height=500, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="button2" >
<?php }

if($rowsProps2['end_review']=='Yes' and $rFLists2['awarded']=='Yes'){?>
<div class='btn-info-purple'><a href="<?php echo $base_ur;?>main.php?option=conceptNewSubmissionsMain"><?php echo $lang_GrantsAwarded;?></a></div>
<?php }
