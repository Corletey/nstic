...
echo "<meta http-equiv='REFRESH' content='0;url=$base_url/main.php?option=SubmitAmendments&id=$projectID'>";
}
if($totalStagesConfirm){
...
/*echo("<script>location.href = '".$base_url."'main.php?option=SubmitAmendments/$projectID';</script>");*/
