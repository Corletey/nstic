...
values('$asrmApplctID','$protocol_id','$DocumentName','$Version','$Description','$Attachment2',now(),'Technical')";
$mysqli->query($sqlA2);
...
if( $message){echo  $message;}
 ...
 <h4 class="niceheaders"><?php echo $lang_TechnicalReports;?></h4><hr />
 <div style="margin-top:5px;"></div>
<span  class="button2" style="float:left; padding:10px;"><a href="exportmreports.php?en=Technical"> <?php echo $lang_ExportResults;?></a></span>
 
 <button id="myBtn"><?php echo $lang_AddNew.' '.$lang_TechnicalReports;?> </button> 
...
*/
if($id){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."monitoring_reports  where category='Technical' order by id desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($id){
$sql = "select *,DATE_FORMAT(`docDate`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."monitoring_reports where category='Technical' order by id desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
