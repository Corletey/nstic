...
///Get project Owner
$wmOwner="select * from ".$prefix."submissions_proposals where  projectID='$id' and grantcallID='$grantID'";
...
values('$conceptm_id','$cfnreviewer','$owner_id',now(),'new','proposals','$usrm_id','none','no',NULL,'dynamic','$grantID')";
...
$mail->AddAddress($usrm_email, $nameofpi); //To Address -- CHANGE --$conceptm_email
...
A proposal, <b>$proposalTittle</b> has been assigned to you for review. Please <a href='".$base_url."''>Click here</a>  to access the proposal.</p>
...
$sqlUsers4="SELECT * FROM ".$prefix."submissions_proposals where projectID='$id' and grantcallID='$grantID' order by projectID desc limit 0,1";
...
<?php /*?><div class="tab">
 ...
 <button class="tablinks" onClick="window.location.href='./main.php?option=reviewPrososal&id=<?php echo $id;?>'"><?php echo $lang_new_ProjectInformation;?></button>
  ...
  <button class="tablinks" onClick="window.location.href='./main.php?option=reviewproposalBackground&id=<?php echo $id;?>'"><?php echo $lang_new_Background;?> </button>
    <button class="tablinks" onClick="window.location.href='./main.php?option=reviewproposalMethodology&id=<?php echo $id;?>'"><?php echo $lang_new_ApproachMethodology;?> </button><button class="tablinks" onClick="window.location.href='./main.php?option=reviewproposalBudget&id=<?php echo $id;?>'"><?php echo $lang_new_Budget;?></button>
  ...
  <button class="tablinks" onclick="openCity(event, 'ReviewproposalAssign')" id="defaultOpen"><?php echo $lang_new_ProjectFollowup;?></button>
  
</div>



<div id="ReviewproposalAssign" class="tabcontent"><?php */?>



  <h3>Assign Proposal</h3><?php if($message){?><span style="color:#03F; font-size:18px;"><?php  echo $message;?></span> <?php }?>
...
$sqlUsers2 = "SELECT * FROM ".$prefix."musers 
              WHERE usrm_usrtype='reviewer' 
              AND FIND_IN_SET('$researchTypeID', categoryID) > 0 
              ORDER BY usrm_fname ASC 
              LIMIT 0,30";
