 ...
 <h4 class="niceheaders"><?php echo $lang_SubmittedProposals;?></h4>
<?php
...
$sqlGroupTotalCOncepts="SELECT * FROM ".$prefix."submissions_proposals where grantcallID='$grantID' order by projectID desc";
...
$TotalCOncepts = $sqlFGrpDisCTotalCOncepts->num_rows;
 ...
 <?php if($rFLists2['dynamic']!='Yes'){?><span  class="button2"><a href="./main.php?option=AllNewProposals&id=<?php echo $rFLists2['grantID'];?>"><?php echo $lang_ViewAll;?>: [<?php echo $TotalCOncepts;?>]</a></span><?php }?>
