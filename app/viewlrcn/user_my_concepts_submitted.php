<h4 class="niceheaders">My Concepts</h4>
<?php
$page='main.php?';
$url='category=';
$value='UserConcepts&id='.$id;
...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_concepts where owner_id='$usrm_id' order by conceptID desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts  where owner_id='$usrm_id' order by conceptID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
