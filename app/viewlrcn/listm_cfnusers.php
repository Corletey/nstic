  <!-- Content Header (Page header) -->
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="./main.php?option=ausers"><i class="fa fa-dashboard"></i> Add new Users</a></li>
...
if($session_usertype=='reviewer' || $session_usertype=='user' || $session_usertype=='admin'){?>  
<div class="box">
...
<?php
$sql = "select *,DATE_FORMAT(`usrm_updated`,'%W, %D %M %Y') AS cfn_regdatem from ".$prefix."musers where usrm_id='$usrm_id'";
...
?>
                   <tbody>
                                            <tr>
                                                <td valign="top">
<img src="img/edit.gif" /> <a href="./main.php?option=myusers&id=<?php echo $sq['usrm_id'];?>">Update Details</a>
                                                </td>
                                                <td><?php echo $sq['usrm_fname'];?> <?php echo $sq['usrm_sname'];?></td>
	...
	?>
                   <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $sq['usrm_phone'];?></td>
                                                <td align="left">
<span style="color:#F00; font-weight:bold; font-size:12px;"><?php if($sq['usrm_usrtype']=='superadmin'){echo "Administrator";}?></span>
