...
$usrrsLoggedId=$rsLogged['usrm_id'];
	...
	//////get all//////////////////////////
$queryContributionLogs="select * from ".$prefix."conceptsasslogs_new where conceptm_id='$id' and conceptm_assignedto='$usrrsLoggedId' and categorym='concepts'";
...
//////////////////////////////////////////////////////////////////////////////////////
$queryContribution2="select * from ".$prefix."submissions_concepts where conceptID='$id'";
...
//////////////////////////////////////////////////////////////////////////////
$sqlScoresMain = "SELECT * FROM ".$prefix."mscores_dynamic where conceptm_id='$id' and EvaluatedBy='$conceptm_assignedto' and openstatus='open' and categorym='concepts'";
...
$sqlScores = "SELECT * FROM ".$prefix."mscores_dynamic where conceptm_id='$id' and EvaluatedBy='$conceptm_assignedto' and openstatus='open' and grantID='$grantcallID' and question_id='$finalCategoryID' and categorym='concepts'";
...
values('$id','$EvTotalScore','$sessionusrm_id',now(),'$ownermID','$scomment','$overallcomment','concepts','open','$finalCategoryID','$Verdict','$grantcallID')";
...
if($totalScores){
$queryScores="update ".$prefix."mscores_dynamic set `EvTotalScore`='$EvTotalScore',`scomment`='$scomment',`EvoverallComment`='$overallcomment',`Verdict`='$Verdict' where conceptm_id='$id' and EvaluatedBy='$sessionusrm_id' and question_id='$finalCategoryID' and grantID='$grantcallID' and categorym='concepts'";
$mysqli->query($queryScores);
...
$sqlUsers4="SELECT * FROM ".$prefix."submissions_concepts where conceptID='$id' and grantcallID='$grantcallID' order by conceptID desc limit 0,1";
$QueryUsers4 = $mysqli->query($sqlUsers4);
$rUserInv4=$QueryUsers4->fetch_array();

//////////////////////////Score

$sqlUsersScore="SELECT * FROM ".$prefix."mscores_dynamic where conceptm_id='$id' and EvaluatedBy='$sessionusrm_id'  and openstatus='open' and grantID='$grantcallID'   and categorym='concepts' order by scoredmID desc limit 0,1";
...
while($rQuestions=$QueryQuestions->fetch_array()){
	...
	$sqlScores2 = "SELECT * FROM ".$prefix."mscores_dynamic where conceptm_id='$id' and EvaluatedBy='$conceptm_assignedto' and question_id='$question_id'  and grantID='$grantcallID'  and categorym='concepts'";
