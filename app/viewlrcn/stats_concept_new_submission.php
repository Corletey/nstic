...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_concepts where projectStatus='$status' order by Totalaverage desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts where projectStatus='$statusw'  order by Totalaverage desc LIMIT $start, $limitm";//and conceptm_status='new' 
}

if(!$_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts where projectStatus='$status'  order by Totalaverage desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
...
$wmConfirmAverage="update ".$prefix."submissions_concepts set Totalaverage='$TotalScore' where  owner_id='$owner_id' and conceptID='$conceptID' and grantcallID='$grantcallID'";
$mysqli->query($wmConfirmAverage);}
}
