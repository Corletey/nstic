...
$page='main.php?';
$url='category=';
$value='AdminScheduledProposalsReview&id='.$id;
...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."submissions_concepts where finalSubmission='Scheduled for Review' and category='proposal' order by conceptID desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select *,DATE_FORMAT(`updatedon`,'%d/%m/%Y') AS updatedonm FROM ".$prefix."submissions_concepts  where finalSubmission='Scheduled for Review' and category='proposal' order by conceptID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
...
<?php if($rFLists2['projectStatus']=='Pending Review'){?><a href="./main.php?option=reviewProjectInformation&id=<?php echo $rFLists2['conceptID'];?>" class='button3'><?php echo $lang_ClicktoViewDetails;?></a> <?php }?>

<?php if($rFLists2['projectStatus']=='Reviewed'){?><a href="./main.php?option=reviewProjectInformation&id=<?php echo $rFLists2['conceptID'];?>" class='button3'><?php echo $lang_ClicktoViewDetails;?></a> <?php }?>

<?php if($rFLists2['projectStatus']=='Approved'){?><a href="./main.php?option=reviewProjectInformation&id=<?php echo $rFLists2['conceptID'];?>" class='button3'><?php echo $lang_FowardforReview;?></a> <?php }?>
