                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Proposal Submission - $rstug_rsch_project_title</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<strong>RE: <u>$title</strong></u><br><br>
Dear $dbfirstname $dbsurname,<br><br>

Your concept '<b>$rstug_rsch_project_title</b>' was considered for the next stage of evaluation. Please submit a full proposal of this concept by <strong>$EndDate</strong>.<br><br>
Proposal submission date: <strong>$startDate</strong><br>
Proposal end date: <strong>$EndDate</strong><br><br>

$details<br><br>

To submit, <a href='".$base_url."''>Click Here to Login</a>.<br>
