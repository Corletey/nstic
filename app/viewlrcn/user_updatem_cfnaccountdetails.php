...
$sqlA1="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_password`='$md5pass',`usrm_phone`='$phone',`usrm_profilepic`='$newname',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob' where usrm_id='$usrm_id'";
$mysqli->query($sqlA1);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}

if($_FILES["profilepic"]["name"] and !$_POST['pwd']){
$sqlA2="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_phone`='$phone',`usrm_profilepic`='$newname',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob' where usrm_id='$usrm_id'";
$mysqli->query($sqlA2);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
...
if(!$_FILES["profilepic"]["name"] and $_POST['pwd']){
$sqlA3="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_password`='$md5pass',`usrm_phone`='$phone',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob' where usrm_id='$usrm_id'";
$mysqli->query($sqlA3);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
...
if(!$_FILES["profilepic"]["name"] and !$_POST['pwd']){
$sqlA4="update ".$prefix."musers set `usrm_NameofInstitution`='$Institution',`usrm_fname`='$fname',`usrm_sname`='$sname',`usrm_Nationality`='$Nationality',`usrm_phone`='$phone',`usrm_gender`='$Gender',`usrm_Qualification`='$Qualifications',`usrm_dob`='$dob' where usrm_id='$usrm_id'";
$mysqli->query($sqlA4);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
...
<section class="content">
  <?php if($session_usertype=='reviewer' || $session_usertype=='user'){?> 
<form action="./main.php?option=myusers&id=<?php echo $id;?>" method="post" name="regForm" id="regForm" enctype="multipart/form-data" autocomplete="off">
<?php echo $message;?>
...
?>
        ...
        <?php }?>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <input type="password" class="form-control" name="pwd" minlength="5" value="" id="pwd" autocomplete="off">
                                        </div>
