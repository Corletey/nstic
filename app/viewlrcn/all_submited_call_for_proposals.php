<h4 class="niceheaders success"><b><?php echo $lang_SubmittedProposals;?></b></h4>
<?php
$page='main.php?';
$url='option=';
$value='CallProposals&id='.$id;
...
*/
if($_POST['doSearch']){
$query = $mysqli->query("select COUNT(*) as num from ".$prefix."grantcalls  where category='proposals' order by grantID desc");//and conceptm_status='new' 
}
...
/* Get data. */
if($_POST['doSearch']){
$sql = "select * FROM ".$prefix."grantcalls where category='proposals' order by grantID desc LIMIT $start, $limitm";//and conceptm_status='new' 
}
...
<?php }?>
 ...
 <?php if($rFLists2['dynamic']=='No' and $rFLists2['end_review']!='Yes' and $session_usertype=='admin' and $_SESSION['usrm_id']==$rFLists2['grant_adminID']){?><span  class="button1"><a href="./main.php?option=DynamicCallProposals&id=<?php echo $rFLists2['grantID'];?>&action=update "><?php echo $lang_ClicktoUpdateSubmission;?></a></span><?php }?>
 
  <?php if($rFLists2['dynamic']=='Yes' and $session_usertype=='admin' and $_SESSION['usrm_id']==$rFLists2['grant_adminID']){?><span  class="button1"><a href="./main.php?option=DynamicCallProposals&id=<?php echo $rFLists2['grantID'];?>&action=update "><?php echo $lang_ClicktoUpdateSubmission;?></a></span><?php }?>                                                      
