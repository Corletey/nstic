...
echo("<script>location.href = './main.php?option=Submitfinish';</script>");
...
<div class="progress-bar progress-bar-info progress-bar-striped" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:80%">80% Complete</div>
</div>
