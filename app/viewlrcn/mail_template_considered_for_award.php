                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Considered for Award - $rstug_rsch_project_title</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
We thank you for responding to the call. Your concept proposal was evaluated by an independent technical committee and was considered for the next stage of evaluation. <br /><br />
