 <?php
 $sqlQnsubmitted_d="SELECT * FROM ".$prefix."concept_dynamic_questions_all_e where categoryID='$categoryIDm' and catadmin_id='$sessionusrm_id' and grantID='$id' and categorym='proposal' order by id desc";
  ...
  <tr>
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_Personnel" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_Personnel']){echo $rowsSubmitted_d['qn_Personnel'];}else{ echo "$lang_new_Personnel";}?>" >

  </td>
    <td> 

 <input name="categoryID" type="hidden" value="<?php echo $categoryIDm;?>" />
      <input type="text" id="qty" name="qn_PersonnelPercentage_Ceiling" placeholder="8" class="required amount" value="<?php echo $rowsSubmitted_d['qn_PersonnelPercentage_Ceiling'];?>" onkeyup="findTotal()" required>

  </td>
    <td>
    <input name="qn_Personnel_status" type="radio" value="Disable" class="required" id="qn_Personnel_status" <?php if($rowsSubmitted_d['qn_Personnel_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
    ...
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_ResearchCosts" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_ResearchCosts']){echo $rowsSubmitted_d['qn_ResearchCosts'];}else{ echo "$lang_new_ResearchCosts";}?>" >

  </td>
    <td> 

 
      <input type="text" id="qn_ResearchCosts_Ceiling" name="qn_ResearchCosts_Ceiling" class="required amount" placeholder="60" value="<?php echo $rowsSubmitted_d['qn_ResearchCosts_Ceiling'];?>" onkeyup="findTotal()" required>

  </td>
    <td>
    <input name="qn_ResearchCosts_status" type="radio" value="Disable" class="required" id="qn_ResearchCosts_status" <?php if($rowsSubmitted_d['qn_ResearchCosts_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
    <input name="qn_ResearchCosts_status" type="radio" value="Enable" class="required number inputmain31"  id="qn_ResearchCosts_status" <?php if($rowsSubmitted_d['qn_ResearchCosts_status']=='Enable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Enable;?>
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_Equipment" placeholder="" class="required number inputmain31" value="<?php if($rowsSubmitted_d['qn_Equipment']){echo $rowsSubmitted_d['qn_Equipment'];}else{ echo "$lang_new_Equipment";}?>" >
    ...
    <td>
    <input name="qn_Equipment_Ceiling_status" type="radio" value="Disable" class="required" id="qn_Equipment_Ceiling_status" <?php if($rowsSubmitted_d['qn_Equipment_Ceiling_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_Travel" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_Travel']){echo $rowsSubmitted_d['qn_Travel'];}else{ echo "$lang_new_TravelandSubsistence";}?>" >
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_kickoff" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_kickoff']){echo $rowsSubmitted_d['qn_kickoff'];}else{ echo "$lang_new_GRatKickoff";}?>" >
    ...
    <input name="qn_kickoff_status" type="radio" value="Disable" class="required" id="qn_kickoff_status" <?php if($rowsSubmitted_d['qn_kickoff_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_KnowledgeSharing" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_KnowledgeSharing']){echo $rowsSubmitted_d['qn_KnowledgeSharing'];}else{ echo "$lang_new_KnowledgeSharing";}?>" >
    ...
    <td><input name="qn_KnowledgeSharing_status" type="radio" value="Disable" class="required" id="qn_KnowledgeSharing_status" <?php if($rowsSubmitted_d['qn_KnowledgeSharing_status']=='Disable'){?>checked="checked"<?php }?>/> <?php echo $lang_new_Disable;?><br />
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_OverheadCosts" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_OverheadCosts']){echo $rowsSubmitted_d['qn_OverheadCosts'];}else{ echo "$lang_new_Overheadcosts";}?>" >
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_OtherGoods" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_OtherGoods']){echo $rowsSubmitted_d['qn_OtherGoods'];}else{ echo "$lang_new_Othergoodsservices";}?>" >
   ...
   <tr>
    <td> 
      ...
      <input type="text" id="MyTextBox" name="qn_MatchingSupport" placeholder="" class="required" value="<?php if($rowsSubmitted_d['qn_MatchingSupport']){echo $rowsSubmitted_d['qn_MatchingSupport'];}else{ echo "$lang_new_MatchingSupportifany";}?>" >
  ...
  <tr>
    ...
    <td> 
    <?php
	/*$totals=($rowsSubmitted_d['qn_PersonnelPercentage_Ceiling']+$rowsSubmitted_d['qn_ResearchCosts_Ceiling']+$rowsSubmitted_d['qn_Equipment_Ceiling']+$rowsSubmitted_d['qn_Travel_Ceiling']+$rowsSubmitted_d['qn_kickoff_Ceiling']+$rowsSubmitted_d['qn_KnowledgeSharing_Ceiling']+$rowsSubmitted_d['qn_OverheadCosts_Ceiling']+$rowsSubmitted_d['qn_OtherGoods_Ceiling']+$rowsSubmitted_d['qn_MatchingSupport_Ceiling']);*/
