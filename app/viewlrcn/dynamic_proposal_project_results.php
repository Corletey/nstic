...
$extension = strtolower($extension);
	...
	$sqlUsers="SELECT * FROM ".$prefix."project_results where `owner_id`='$asrmApplctID' and `grantID`='$id' order by projectID desc limit 0,1";
...
,'$ResearchOutputsIndicators1','$ResearchOutputsIndicators2','$ResearchOutputsIndicators3','$ResearchOutputsIndicators4','$ResearchOutputsIndicators5','$ResearchOutputsIndicators6','$ResearchOutputsIndicators7','$ResearchOutcomes1','$ResearchOutcomes2','$ResearchOutcomes3','$ResearchOutcomes4','$ResearchOutcomes5','$ResearchOutcomes6','$ResearchOutcomes7','$ResearchOutcomesIndicators1','$ResearchOutcomesIndicators2','$ResearchOutcomesIndicators3','$ResearchOutcomesIndicators4','$ResearchOutcomesIndicators5','$ResearchOutcomesIndicators6','$ResearchOutcomesIndicators7','$Impact1','$Impact2','$Impact3','$Impact4','$Impact5','$Impact6','$Impact7','0','$id')";
$mysqli->query($sqlA2);
$record_id = $mysqli->insert_id;

if($record_id>=1){
	
	if($_POST['ResearchOutputs1']){
...
$wm3="select * from ".$prefix."research_impact_pathway where  ResearchOutputs1='$ResearchOutputs1' and projectID='$projectID' and ResearchOutputsIndicators1='$ResearchOutputsIndicators1' and ResearchOutcomes1='$ResearchOutcomes1' and grantID='$id'";
$cmdwb3 = $mysqli->query($wm3);
if(!$cmdwb3->num_rows){
$Insert_QRRR2="insert into ".$prefix."research_impact_pathway (`resultsID`,`projectID`,`owner_id`,`ResearchOutputs1`,`ResearchOutputsIndicators1`,`ResearchOutcomes1`,`ResearchOutcomesIndicators1`,`Impact1`,`grantID`) values ('$record_id','$projectID','$asrmApplctID','$ResearchOutputs1','$ResearchOutputsIndicators1','$ResearchOutcomes1','$ResearchOutcomesIndicators1','$Impact1','$id')";
...
echo("<script>location.href = '".$base_url."'main.php?option=newproposalManagement&id=$id&categoryID=$categoryID&conceptID=$conceptID';</script>");
*/
////Re-direct to another page below
echo "<meta http-equiv='REFRESH' content='0;url=$base_url/main.php?option=newproposalManagement&id=$id&categoryID=$categoryID&conceptID=$conceptID'>";
//end
...
$ResearchOutcomesIndicators1=$_POST['ResearchOutcomesIndicators1'][$i];
$Impact1=$_POST['Impact1'][$i];
$record_idPathWay=$_POST['record_idPathWay'][$i];
$wm3="select * from ".$prefix."research_impact_pathway where  ResearchOutputs1='$ResearchOutputs1' and projectID='$projectID' and ResearchOutputsIndicators1='$ResearchOutputsIndicators1' and ResearchOutcomes1='$ResearchOutcomes1' and grantID='$id'";
$cmdwb3 = $mysqli->query($wm3);
if(!$cmdwb3->num_rows){
$Insert_QRRR2="insert into ".$prefix."research_impact_pathway (`resultsID`,`projectID`,`owner_id`,`ResearchOutputs1`,`ResearchOutputsIndicators1`,`ResearchOutcomes1`,`ResearchOutcomesIndicators1`,`Impact1`,`grantID`) values ('$record_idPathWay','$projectID','$asrmApplctID','$ResearchOutputs1','$ResearchOutputsIndicators1','$ResearchOutcomes1','$ResearchOutcomesIndicators1','$Impact1','$id')";
$mysqli->query($Insert_QRRR2);
}
	}
}
...
if($totalStages){
$sqlASubmissionStages="update ".$prefix."project_stages  set `ProjectResults`='1' where `owner_id`='$asrmApplctID' and grantID='$id'";
$mysqli->query($sqlASubmissionStages);
}
...
$sqlUsers2="SELECT * FROM ".$prefix."project_results where `owner_id`='$usrm_id' and `grantID`='$id' order by projectID desc limit 0,1";
...
<?php if($total_Results){?><button <?php if($rUConceptStages['ProjectResults']==1){?>class="tablinks"<?php }?> onclick="openCity(event, 'newproposalResults')" id="defaultOpen"><?php echo $lang_new_ProjectResults;?></button><?php }?>
...
<div id="newproposalResults" class="tabcontent">
...
var inp5 = new_row.cells[4].getElementsByTagName('input')[0];
  ...
  <h3><?php echo $lang_new_ProjectResults;?></h3>
   ...
   <?php
$sqlQnsubmitted_c="SELECT * FROM ".$prefix."concept_dynamic_questions_all_j where grantID='$id' and categorym='proposal' order by id desc";
...
<label for="fname"><?php echo $lang_new_RequiredFieldsMarked;?> (<span class="error">*</span>)</label>
  <div class="row success">
    ...
    <div class="col-100">
    <label for="fname"><strong><?php echo $rowsSubmitted_c['logicalflow'];?>  <span class="error">*</span></label>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="POITable">
        <tr>
           ...
           <td width="20%"><strong><em><?php echo $lang_Researchoutputs;?></em></strong></td>
    <td width="17%"><strong><em><?php echo $lang_Indicators;?></em></strong></td>
    <td width="20%"><strong><em><?php echo $lang_Researchoutcomes;?></em></strong></td>
    <td width="16%"><strong><em><?php echo $lang_Indicators;?></em></strong></td>
    <td width="14%"><strong><em><?php echo $lang_Impact;?></em></strong></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
...
$sqlDelete="DELETE FROM ".$prefix."research_impact_pathway where `owner_id`='$usrm_id' and `grantID`='$id' and id='$impc'";
$mysqli->query($sqlDelete);	
}
$sqlProjectID="SELECT * FROM ".$prefix."research_impact_pathway where `owner_id`='$usrm_id' and `grantID`='$id'";
$QueryProjectID = $mysqli->query($sqlProjectID);
...
?>
    ...
    <td width="14%"><?php echo $rUserProjectID['Impact1'];?></td>
            <td>&nbsp;</td>
            <td><a href="./main.php?option=newproposalResults&id=<?php echo $id;?>&categoryID=&conceptID=&impc=<?php echo $rUserProjectID['id'];?>&del=true"  style="background-color:#F00; color:#fff;padding:5px;" onclick="return confirm('Are you sure you want to Delete?');">Delete</a></td>
        </tr>
        <?php }?>
        </table>
...
<input name="record_idPathWay" type="hidden" value="<?php echo $rUserInv2['id'];?>"/>
...
<textarea id="MyTextBoxmm3002" name="CommunicationWithStakeholders" placeholder="" style="height:150px" class="required" required><?php echo $rUserInv2['CommunicationWithStakeholders'];?></textarea>
  ...
  if($rowsSubmitted_c['ScientificOutput_status']){?>
     <div class="row success">
