...
?>    
   ...
   <div class="success" style="font-size:18px;"><?php echo $lang_Award;?> <?php echo $OwnerName;?></div>             
      <?php
...
$sqlFLists1="SELECT *,DATE_FORMAT(`updatedon`,'%d/%m/%Y %H:%s:%i') AS updatedonm FROM ".$prefix."submissions_concepts where conceptID='$id' order by conceptID desc";
...
$sqlA2ProtocolaSS="update ".$prefix."submissions_concepts set projectStatus='Reviewed',awarded='$awarded',`BeginProject`='$dateSubmitted2',`EndProject`='$endofproject22',`AmountofGrantawarded`='$AmountofGrantawarded',`DurationofGrant`='$DurationofGrant',`TermsConditions`='No',`currency`='$currency',`award_agreement`='$awardagreement2' where conceptID='$id'";
...
$DurationofGrant="$projectDurationID Months";
$sqlA2ProtocolaSS="update ".$prefix."submissions_concepts set projectStatus='Reviewed',awarded='$awarded',`BeginProject`='$dateSubmitted2',`EndProject`='$endofproject22',`AmountofGrantawarded`='$AmountofGrantawarded',`DurationofGrant`='$DurationofGrant',`TermsConditions`='No',`currency`='$currency' where conceptID='$id'";
$mysqli->query($sqlA2ProtocolaSS);	
...
<form action="" name="regForm" id="regForm" method="post" enctype="multipart/form-data" autocomplete="off">
                         ...
                         <div class="form-group row success">
							...
							<input name="awarded" type="radio" value="no" class="required" onChange="getAwardGranted(this.value)"> &nbsp;<?php echo $lang_No;?> &nbsp;&nbsp;<input name="awarded" type="radio" value="yes" class="required" onChange="getAwardGranted(this.value)"> <?php echo $lang_Yes;?>
                    ...
                    <input name="doSaveAward" type="submit"  class="btn btn-primary" value="<?php echo $lang_Confirm;?>"/>
