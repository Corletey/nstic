...
////////////////////Get Base URL Link/////////////////////
$base_url_localhost = getenv('BASE_URL_LOCALHOST');
$base_url_production = getenv('BASE_URL_PRODUCTION');
$base_url_www = getenv('BASE_URL_WWW');

if ($_SERVER['HTTP_HOST'] == "localhost") {
    $base_url = $base_url_localhost;
} 
if ($_SERVER['HTTP_HOST'] == "appelaprojets.fonrid.com") {
    $base_url = $base_url_production;
} 
if ($_SERVER['HTTP_HOST'] == "www.appelaprojets.fonrid.com") {
   $base_url = $base_url_www;
}
...
/*
//Office 365 alternative configuration (if needed)
